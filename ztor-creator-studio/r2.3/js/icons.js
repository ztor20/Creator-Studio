...
const REGISTRY = {
  ...
  /* 側欄收合／展開（2026-08-31 建）。用「面板＋箭頭」而不是單純的雙箭頭：
     單獨的箭頭在站上已經是「上一張／下一張」與「查看更多」的意思，同一個形狀
     再拿來講「把這一欄收起來」，讀者要在三種意思之間猜。面板的輪廓一眼說明
     被收起來的是什麼。 */
  'sidebar-collapse': '<path d="M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" /> <path d="M9 4v16" /> <path d="M15 10l-2 2l2 2" />',
  'sidebar-expand':   '<path d="M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" /> <path d="M9 4v16" /> <path d="M14 10l2 2l-2 2" />',
  ...
  'device-tv':      '<path d="M3 9a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2l0 -8" /> <path d="M16 3l-4 4l-4 -4" />',  // 影集（建立項目的內容類型磚）
  ...
  'ban':            '<path d="M5.7 5.7l12.6 12.6" /> <path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0" />',  // 列操作：停用（優惠碼）
  'ticket-percent': '<path d="M15 5l0 2" /> <path d="M15 11l0 2" /> <path d="M15 17l0 2" /> <path d="M5 5h14a2 2 0 0 1 2 2v3a2 2 0 0 0 0 4v3a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-3a2 2 0 0 0 0 -4v-3a2 2 0 0 1 2 -2" /> <path d="M9 14l2 -4" />',  // 優惠碼空狀態
  'photo-video':    '<path d="M9 15h-3a3 3 0 0 1 -3 -3v-6a3 3 0 0 1 3 -3h6a3 3 0 0 1 3 3v3" /> <path d="M9 12a3 3 0 0 1 3 -3h6a3 3 0 0 1 3 3v6a3 3 0 0 1 -3 3h-6a3 3 0 0 1 -3 -3l0 -6" /> <path d="M3 12l2.296 -2.296a2.41 2.41 0 0 1 3.408 0l.296 .296" /> <path d="M14 13.5v3l2.5 -1.5l-2.5 -1.5" /> <path d="M7 6v.01" />',   // 展示素材槽的空狀態：這一格收圖片或影片（D259）
  ...
  'inbox':          '<path d="M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2l0 -12" /> <path d="M4 13h3l3 3h4l3 -3h3" />',  // event-detail 作廢紀錄空狀態（2026-09-09 D253 由退款空狀態改用途）
  ...
  'brand-tiktok': '<path d="M21 7.917v4.034a9.948 9.948 0 0 1 -5 -1.951v4.5a6.5 6.5 0 1 1 -8 -6.326v4.326a2.5 2.5 0 1 0 4 2v-11.5h4.083a6.005 6.005 0 0 0 4.917 4.917" />',   // 粉絲端創作者頁鏡像的社群圓鈕（fan-store，2026-09-11）
  'brand-youtube':  '<path d="M2 8a4 4 0 0 1 4 -4h12a4 4 0 0 1 4 4v8a4 4 0 0 1 -4 4h-12a4 4 0 0 1 -4 -4v-8z" /> <path d="M10 9l5 3l-5 3z" />',   // 店面社群連結可加的平台（store-settings，2026-09-11）
  'brand-spotify':  '<path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /> <path d="M8 11.973c2.5 -1.473 5.5 -.973 7.5 .527" /> <path d="M9 15c1.5 -1 4 -1 5 .5" /> <path d="M7 9c2 -1 6 -2 10 .5" />',   // 店面社群連結可加的平台（store-settings，2026-09-11）
  'brand-twitch':   '<path d="M4 5v11a1 1 0 0 0 1 1h2v4l4 -4h5.584c.266 0 .52 -.105 .707 -.293l2.415 -2.414c.187 -.188 .293 -.442 .293 -.708v-8.585a1 1 0 0 0 -1 -1h-14a1 1 0 0 0 -1 1z" /> <path d="M16 8l0 4" /> <path d="M12 8l0 4" />',   // 店面社群連結可加的平台（store-settings，2026-09-11）
  ...
  /* 2026-08-18：只有驚嘆號、不含外圈（Tabler exclamation-mark）。給本身已經是一個圓的
     容器用——step-list 的 --alert 記號外面就是一圈 2px 色環，再放一顆 alert-circle
     等於兩個同心圓。 */
  'exclamation-mark': '<path d="M12 19v.01" /> <path d="M12 15v-10" />',                                                                                                                                       // Failed / Disputed
  ...
  'globe':          '<path d="M7 9a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /> <path d="M5.75 15a8.015 8.015 0 1 0 9.25 -13" /> <path d="M11 17v4" /> <path d="M7 21h8" />',                                                                            // Supported regions（地球儀造型：球體＋支架，別拿來當語言切換）
  'world':          '<path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0" /> <path d="M3.6 9h16.8" /> <path d="M3.6 15h16.8" /> <path d="M11.5 3a17 17 0 0 0 0 18" /> <path d="M12.5 3a17 17 0 0 1 0 18" />',                                       // 語言選擇（登入頁）：純地球、經緯線，無底座
