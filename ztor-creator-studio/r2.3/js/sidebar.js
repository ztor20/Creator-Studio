...
(function () {
  ...
  const ADMIN_ROUTES = new Set(["creators.html", "creator-detail.html", "admin-creator-events.html", "admin-ip-bank.html", "admin-ip-bank-entry.html", "ip-bank-reporting.html", "admin-platform-fees.html", "admin-platform-discounts.html", "admin-video-review.html"]);
  const ADMIN_NAV = [
    ...
    /* 平台滿額折扣設定（D273）：Admin 同層目的地由六個增為七個，排在平台費率設定之後。 */
    { href: "admin-platform-discounts.html", key: "admin.platform-discounts", icon: "ticket-percent" }
  ];
  ...
  const FULL_ROUTES = new Set([
    "index.html", "dashboard-classic.html", "creators.html", "admin-ip-bank.html", "admin-ip-bank-entry.html", "ip-bank-reporting.html", "admin-platform-fees.html", "admin-platform-discounts.html", "admin-video-review.html", "projects.html", "project-detail.html", "create-project.html",
