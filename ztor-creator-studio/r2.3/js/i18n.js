...
(function () {
  ...
  const DICT = {
    ...
    'e-shop.unlist.body':       { en: 'Public and private links stop working and fans no longer see its page. You can relist it anytime.', zh: '公開與非公開連結都會失效，粉絲端不再有它的頁面；隨時可以重新上架。' },
    'e-shop.unlist.confirm':    { en: 'Unlist',                            zh: '下架' },
    'e-shop.unlist.blocked-title': { en: '“{n}” is still in listed bundles', zh: '「{n}」仍在上架中的組合包裡' },
    'e-shop.unlist.blocked-body':  { en: 'Unlisting it also unlists these bundles:', zh: '下架後這些組合包也會一同下架：' },
    ...
    'e-shop.relist.members-body':  { en: 'These unlisted items go back on sale with it:', zh: '這些已下架的成員會一起重新上架：' },
