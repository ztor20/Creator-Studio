...
(function () {
  ...
  const DICT = {
    ...
    'admin.platform-discounts': { en: 'Platform Discount Settings', zh: '平台折扣設定' },
    'pdisc.sub': { en: 'A threshold discount for every buyer, platform-wide. Creators absorb the cost — set exceptions for individual creators below.', zh: '全平台買家的滿額折扣，成本由創作者吸收；可在下方設定例外藝人。' },
    'pdisc.tab.rules': { en: 'Rules', zh: '規則' },
    'pdisc.tab.excluded': { en: 'Excluded creators', zh: '例外藝人' },
    'pdisc.tab.records': { en: 'Records', zh: '紀錄' },
    'pdisc.save': { en: 'Save', zh: '儲存' },
    'pdisc.save.hint': { en: 'Saving creates a new version that applies to future orders only — existing orders keep their frozen rule.', zh: '儲存即發版，只對之後成立的訂單生效，既有訂單維持原本凍結的規則。' },
    'pdisc.exc.add': { en: '+ Add exception', zh: '＋ 加入例外' },
    'pdisc.tiers.title': { en: 'Threshold discount tiers', zh: '滿額折扣階層' },
    'pdisc.tiers.hint': { en: 'An order applies only the highest tier it reaches, never more than one. The threshold looks at the item subtotal after discount codes, before shipping.', zh: '一張訂單只套達到的最高一階，不累加。門檻看優惠碼折後的品項小計，不含運費。' },
    'pdisc.tiers.col.threshold': { en: 'Threshold', zh: '門檻金額' },
    'pdisc.tiers.col.method': { en: 'Discount', zh: '折抵方式' },
    'pdisc.tiers.col.value': { en: 'Amount', zh: '折抵值' },
    'pdisc.tiers.add': { en: '+ Add a tier', zh: '＋ 加一階' },
    'pdisc.tiers.remove': { en: 'Remove tier', zh: '移除這一階' },
    'pdisc.tiers.unit.fixed': { en: 'Fixed', zh: '固定' },
    'pdisc.tiers.unit.pct': { en: '%', zh: '%' },
    'pdisc.auction.note': { en: 'Whether auction sales count toward the threshold: product decision pending.', zh: '拍賣是否計入門檻與折抵：產品待確認。' },
    'pdisc.period.label': { en: 'Effective period', zh: '生效期間' },
    'pdisc.period.hint': { en: 'Leave the end date empty to keep it open-ended.', zh: '結束日留空代表長期有效。' },
    'pdisc.period.start-aria': { en: 'Starts', zh: '開始日期' },
    'pdisc.period.end-aria': { en: 'Ends', zh: '結束日期' },
    'pdisc.enabled.label': { en: 'Enabled', zh: '啟用' },
    'pdisc.enabled.hint': { en: 'Pausing stops the rule for orders placed from now on; existing orders are unaffected.', zh: '暫停即刻停止套用於之後成立的訂單，既有訂單不受影響。' },
    'pdisc.notes.label': { en: 'Internal note', zh: '內部說明' },
    'pdisc.notes.hint': { en: 'Not shown to buyers.', zh: '不對買家顯示。' },
    'pdisc.notes.ph': { en: 'Campaign name, decision reference…', zh: '活動名稱、決策依據…' },
    'pdisc.version.title': { en: 'Version history', zh: '版本' },
    'pdisc.version.hint': { en: 'Append-only — corrections show up as a new version, never an edit in place.', zh: 'append-only，更正以新版本表示，不原地改寫。' },
    'pdisc.version.col.version': { en: 'Version', zh: '版本' },
    'pdisc.version.col.effective': { en: 'Effective', zh: '生效區間' },
    'pdisc.version.col.change': { en: 'Change', zh: '異動' },
    'pdisc.version.active': { en: 'Active', zh: '生效中' },
    'pdisc.version.v3': { en: 'Added tier 2: spend 300 get 40 off', zh: '新增第二階：滿 300 折 40' },
    'pdisc.version.v2': { en: 'Tier 1 changed: spend 100 get 8 off → get 10 off', zh: '調整第一階：滿 100 折 8 → 折 10' },
    'pdisc.version.v1': { en: 'Initial setup: spend 100 get 8 off', zh: '初始設定：滿 100 折 8' },
    'pdisc.version.manual-save': { en: 'Rules or effective period updated', zh: '規則或生效期間已更新' },
    'pdisc.excluded.hint': { en: 'An excluded creator’s items are not counted toward the threshold and are never discounted.', zh: '例外藝人的品項不計入門檻、也不被折抵。' },
    'pdisc.excluded.col.creator': { en: 'Creator', zh: '藝人' },
    'pdisc.excluded.col.added': { en: 'Added', zh: '加入時間' },
    'pdisc.excluded.col.by': { en: 'Added by', zh: '操作者' },
    'pdisc.excluded.col.reason': { en: 'Reason', zh: '原因' },
    'pdisc.excluded.remove': { en: 'Remove', zh: '移除' },
    'pdisc.excluded.empty': { en: 'No excluded creators yet — the threshold discount applies to everyone.', zh: '尚無例外藝人，滿額折扣適用所有藝人。' },
    'pdisc.excluded.modal-title': { en: 'Add excluded creator', zh: '加入例外藝人' },
    'pdisc.excluded.search': { en: 'Search a creator', zh: '搜尋藝人' },
    'pdisc.excluded.search-ph': { en: 'Search a creator by name…', zh: '以名稱搜尋藝人…' },
    'pdisc.excluded.search-none': { en: 'No matching creator.', zh: '找不到符合的藝人。' },
    'pdisc.excluded.reason': { en: 'Reason', zh: '原因' },
    'pdisc.excluded.reason-ph': { en: 'Optional, internal use only', zh: '選填，內部使用' },
    'pdisc.excluded.cancel': { en: 'Cancel', zh: '取消' },
    'pdisc.excluded.confirm': { en: 'Add exception', zh: '確認加入' },
    'pdisc.records.toggle.per-order': { en: 'Per order', zh: '逐筆' },
    'pdisc.records.toggle.per-creator': { en: 'Per creator', zh: '依藝人' },
    'pdisc.records.col.time': { en: 'Time', zh: '時間' },
    'pdisc.records.col.order': { en: 'Order', zh: '訂單' },
    'pdisc.records.col.source': { en: 'Source', zh: '來源模組' },
    'pdisc.records.col.subtotal': { en: 'Item subtotal', zh: '品項小計' },
    'pdisc.records.col.tier': { en: 'Tier applied', zh: '套用階' },
    'pdisc.records.col.discount': { en: 'Discount', zh: '折抵' },
    'pdisc.records.col.allocation': { en: 'Allocated to', zh: '分攤藝人' },
    'pdisc.records.col.version': { en: 'Version', zh: '版本' },
    'pdisc.records.source.eshop': { en: 'E-Shop', zh: '電子商店' },
    'pdisc.records.source.events': { en: 'Events', zh: '活動票券' },
    'pdisc.records.source.projects': { en: 'Projects', zh: '項目' },
    'pdisc.records.empty.title': { en: 'No discount records yet', zh: '尚無折抵紀錄' },
    'pdisc.records.empty.text': { en: 'Orders that receive the platform threshold discount will show up here.', zh: '套用平台滿額折扣的訂單會顯示在這裡。' },
    'pdisc.records.pc.col.creator': { en: 'Creator', zh: '藝人' },
    'pdisc.records.pc.col.total': { en: 'Discount absorbed (period)', zh: '期間累計折抵' },
    'pdisc.records.pc.col.orders': { en: 'Orders', zh: '訂單數' },
