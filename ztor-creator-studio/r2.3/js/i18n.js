...
(function () {
  ...
  const DICT = {
    ...
    /* D277（2026-09-15）：頁名改「平台優惠設定」，舊命名空間整個改成 pprom 開頭——
       由單一組滿額規則＋一份例外＋費率式版本，改成「平台滿額折扣」與「平台優惠碼」兩種、
       各自逐筆獨立設定（名稱／期間／啟用／備註／本筆例外／append-only 修改歷史）；
       例外藝人分全局（gexc）與逐筆（各自 exc）三層。舊命名空間的值不保留（見 D277）。 */
    'admin.platform-promotions': { en: 'Platform Promotion Settings', zh: '平台優惠設定' },
    'pprom.sub': { en: 'Two kinds of platform-wide promotion for buyers — threshold discounts and platform codes — each set up as its own record. Creators absorb the cost; exclude individual creators globally or per record below.', zh: '平台對買家的兩種促銷——滿額折扣與平台優惠碼——各自逐筆獨立設定。成本由創作者吸收；可在全局或逐筆設定例外藝人。' },
    'pprom.tab.threshold': { en: 'Threshold discounts', zh: '滿額折扣' },
    'pprom.tab.codes': { en: 'Platform codes', zh: '平台優惠碼' },
    'pprom.tab.excluded': { en: 'Excluded creators', zh: '例外藝人' },
    'pprom.tab.records': { en: 'Records', zh: '紀錄' },
    'pprom.close': { en: 'Close', zh: '關閉' },
    'pprom.cancel': { en: 'Cancel', zh: '取消' },
    'pprom.save': { en: 'Save', zh: '儲存' },
    'pprom.more': { en: 'More actions', zh: '更多操作' },
    'pprom.edit': { en: 'Edit', zh: '編輯' },
    'pprom.duplicate': { en: 'Duplicate', zh: '複製' },
    'pprom.disable': { en: 'Disable', zh: '停用' },
    'pprom.delete': { en: 'Delete', zh: '刪除' },
    'pprom.unit.fixed': { en: 'Fixed', zh: '固定' },
    'pprom.unit.pct': { en: '%', zh: '%' },
    'pprom.f.name': { en: 'Name', zh: '名稱' },
    'pprom.f.period': { en: 'Effective period', zh: '生效期間' },
    'pprom.f.period.hint': { en: 'Leave the end date empty to keep it open-ended.', zh: '結束日留空代表長期有效。' },
    'pprom.f.period.start-aria': { en: 'Starts', zh: '開始日期' },
    'pprom.f.period.end-aria': { en: 'Ends', zh: '結束日期' },
    'pprom.f.enabled': { en: 'Enabled', zh: '啟用' },
    'pprom.f.enabled.hint': { en: 'Pausing stops the rule for orders placed from now on; existing orders are unaffected.', zh: '暫停即刻停止套用於之後成立的訂單，既有訂單不受影響。' },
    'pprom.f.notes': { en: 'Notes', zh: '備註' },
    'pprom.f.notes.ph': { en: 'Optional, internal use only', zh: '選填，內部使用' },
    /* 三層例外的其中兩層：本筆（滿額折扣）／本組（平台優惠碼），做法比照全局例外的搜尋建議清單，
       選中結果落地成可移除 chip。 */
    'pprom.exc.label': { en: 'Excluded creators (this record)', zh: '本筆例外藝人' },
    'pprom.exc.label.code': { en: 'Excluded creators (this code)', zh: '本組例外藝人' },
    'pprom.exc.search-ph': { en: 'Search a creator to exclude…', zh: '搜尋藝人加入例外…' },
    'pprom.exc.search-none': { en: 'No matching creator.', zh: '找不到符合的藝人。' },
    'pprom.history.label': { en: 'Change history', zh: '修改歷史' },
    'pprom.history.new': { en: 'Recording starts after you save.', zh: '儲存後開始記錄。' },
    'pprom.hist.created': { en: 'Created', zh: '新增' },
    'pprom.hist.updated': { en: 'Settings updated', zh: '設定已更新' },
    'pprom.hist.disabled': { en: 'Disabled', zh: '停用' },
    'pprom.hist.enabled': { en: 'Enabled', zh: '啟用' },
    'pprom.status.active': { en: 'Active', zh: '進行中' },
    'pprom.status.upcoming': { en: 'Not started', zh: '未開始' },
    'pprom.status.ended': { en: 'Ended', zh: '已結束' },
    'pprom.status.disabled': { en: 'Disabled', zh: '已停用' },
    'pprom.status.exhausted': { en: 'Exhausted', zh: '已用完' },

    /* ── F2 平台滿額折扣（Threshold Discounts）── */
    'pprom.th.add': { en: 'Add a threshold discount', zh: '＋ 新增滿額折扣' },
    'pprom.th.hint': { en: 'Each order applies only the highest tier it reaches among the rules below, never more than one. The threshold looks at the buyer-side subtotal after fan-tier discounts and codes, before shipping.', zh: '一張訂單只套用達到門檻的各筆中折抵最高的一筆，不累加。門檻看買家層折後（粉絲分級折扣、優惠碼）的品項小計，不含運費。' },
    'pprom.th.col.name': { en: 'Name', zh: '名稱' },
    'pprom.th.col.threshold': { en: 'Threshold → discount', zh: '門檻→折抵' },
    'pprom.th.col.period': { en: 'Effective period', zh: '生效期間' },
    'pprom.th.col.status': { en: 'Status', zh: '狀態' },
    'pprom.th.col.enabled': { en: 'Enabled', zh: '啟用' },
    'pprom.th.col.exceptions': { en: 'Excluded creators', zh: '例外藝人數' },
    'pprom.th.empty.title': { en: 'No threshold discounts yet', zh: '尚無滿額折扣' },
    'pprom.th.empty.text': { en: 'Create the first one so buyers get a discount when their order reaches a spend threshold.', zh: '建立第一筆，買家訂單滿額即可自動折抵。' },
    'pprom.th.auction.note': { en: 'Whether auction sales count toward the threshold: product decision pending.', zh: '拍賣是否計入門檻與折抵：產品待確認。' },
    ...
    /* ── F3 平台優惠碼（Platform Codes）── */
    'pprom.code.add': { en: 'Add a code', zh: '＋ 新增優惠碼' },
    'pprom.code.hint': { en: 'Platform-issued codes buyers type at checkout. Field semantics and buyer-side behavior mirror a creator’s own store codes; the source and exceptions are different.', zh: '平台自己發放、買家結帳輸碼的優惠。欄位語意與買家端行為同創作者自己的優惠碼；來源與例外不同。' },
    'pprom.code.col.name': { en: 'Name', zh: '名稱' },
    'pprom.code.col.code': { en: 'Code', zh: '碼' },
    'pprom.code.col.discount': { en: 'Discount', zh: '折扣' },
    'pprom.code.col.period': { en: 'Effective period', zh: '生效期間' },
    'pprom.code.col.status': { en: 'Status', zh: '狀態' },
    'pprom.code.col.used': { en: 'Used', zh: '已用' },
    'pprom.code.col.exceptions': { en: 'Excluded creators', zh: '例外藝人數' },
    'pprom.code.empty.title': { en: 'No platform codes yet', zh: '尚無平台優惠碼' },
    'pprom.code.empty.text': { en: 'Issue a code so buyers have a reason to check out now, platform-wide.', zh: '發一組碼，讓買家有理由現在就下單，全平台通用。' },
    'pprom.code.modal.add': { en: 'Add a code', zh: '新增優惠碼' },
    'pprom.code.modal.edit': { en: 'Edit code', zh: '編輯優惠碼' },
    'pprom.code.f.name.ph': { en: 'e.g., Welcome offer', zh: '例：歡迎折扣' },
    ...
    'pprom.code.f.fixedmode.hint': { en: 'When multiple items qualify, whether the fixed amount discounts once for the order or once per item.', zh: '多件符合時，固定金額是整單只折一次，還是每件各折一次。' },
    'pprom.code.f.fixedmode.once': { en: 'Once per order (default)', zh: '整單只折一次（預設）' },
    'pprom.code.f.fixedmode.each': { en: 'Once per item', zh: '每件各折一次' },
    'pprom.code.f.scope': { en: 'Applies to', zh: '適用範圍' },
    'pprom.code.f.scope.hint': { en: 'Limiting to a specific module: product decision pending.', zh: '限定模組：產品待確認。' },
    'pprom.code.f.scope.value': { en: 'Platform-wide', zh: '全平台' },
    'pprom.code.f.enabled.hint': { en: 'Pausing stops the code for orders placed from now on; existing orders are unaffected.', zh: '暫停即刻停止套用於之後成立的訂單，既有訂單不受影響。' },
    'pprom.code.f.usage': { en: 'Usage limits', zh: '使用次數' },
    'pprom.code.f.usage.ph': { en: '0 = unlimited', zh: '0 ＝ 不限' },
    'pprom.code.f.perorder': { en: 'Per order', zh: '每張訂單可折件數' },
    'pprom.code.f.perorder.hint': { en: 'One order, that many items — the highest-priced qualifying items get the discount first.', zh: '一張訂單可折這麼多件，優先折單價最高的符合品項。' },
    'pprom.code.f.perbuyer': { en: 'Per buyer total', zh: '每人總次數' },
    'pprom.code.f.perbuyer.hint': { en: 'Adds up across orders, for the same ztor account.', zh: '同一個 ztor 帳號跨訂單累計。' },
    'pprom.code.f.total': { en: 'Total redemptions', zh: '總兌換次數' },
    'pprom.code.f.total.hint': { en: 'Once it runs out, the code’s status switches to Exhausted.', zh: '用完之後狀態自動變成已用完。' },
    'pprom.code.f.stack': { en: 'Stack with other codes', zh: '可與其他優惠碼疊加' },
    'pprom.code.f.stack.hint': { en: 'Both codes need this on to combine in one order — if either is off, only the one better for the buyer applies.', zh: '兩組碼都要開才能同單並用；任一關閉即擇一取對買家最有利。' },

    /* ── F5 例外藝人（全局，Excluded Creators）── */
    'pprom.gexc.add': { en: '+ Add exception', zh: '＋ 加入例外' },
    'pprom.gexc.hint': { en: 'Creators listed here are excluded from every platform promotion. To exclude a creator from just one record, add the exception inside that record’s own setup instead.', zh: '列入這裡的藝人，所有平台優惠都不套用；只退出某一筆，到那一筆的設定裡加。' },
    'pprom.gexc.col.creator': { en: 'Creator', zh: '藝人' },
    'pprom.gexc.col.added': { en: 'Added', zh: '加入時間' },
    'pprom.gexc.col.by': { en: 'Added by', zh: '操作者' },
    'pprom.gexc.col.reason': { en: 'Reason', zh: '原因' },
    'pprom.gexc.col.scope': { en: 'Scope', zh: '範圍' },
    'pprom.gexc.scope.all': { en: 'All', zh: '全部' },
    'pprom.gexc.remove': { en: 'Remove', zh: '移除' },
    'pprom.gexc.empty': { en: 'No global exceptions yet — every platform promotion applies to everyone unless excluded per record.', zh: '尚無全局例外，所有平台優惠適用所有藝人，除非在逐筆設定裡排除。' },
    'pprom.gexc.modal-title': { en: 'Add excluded creator', zh: '加入例外藝人' },
    'pprom.gexc.search': { en: 'Search a creator', zh: '搜尋藝人' },
    'pprom.gexc.search-ph': { en: 'Search a creator by name…', zh: '以名稱搜尋藝人…' },
    'pprom.gexc.search-none': { en: 'No matching creator.', zh: '找不到符合的藝人。' },
    'pprom.gexc.reason': { en: 'Reason', zh: '原因' },
    'pprom.gexc.reason-ph': { en: 'Optional, internal use only', zh: '選填，內部使用' },
    'pprom.gexc.cancel': { en: 'Cancel', zh: '取消' },
    'pprom.gexc.confirm': { en: 'Add exception', zh: '確認加入' },

    /* ── F6 折抵紀錄（Discount Records）── */
    'pprom.records.toggle.per-order': { en: 'Per order', zh: '逐筆' },
    'pprom.records.toggle.per-creator': { en: 'Per creator', zh: '依藝人' },
    'pprom.records.col.time': { en: 'Time', zh: '時間' },
    'pprom.records.col.order': { en: 'Order', zh: '訂單' },
    'pprom.records.col.source': { en: 'Source', zh: '來源模組' },
    'pprom.records.col.subtotal': { en: 'Item subtotal', zh: '品項小計' },
    'pprom.records.col.applied': { en: 'Promotion applied', zh: '套用的優惠' },
    'pprom.records.col.discount': { en: 'Discount', zh: '折抵' },
    'pprom.records.col.allocation': { en: 'Allocated to', zh: '分攤藝人' },
    'pprom.records.source.eshop': { en: 'E-Shop', zh: '電子商店' },
    'pprom.records.source.events': { en: 'Events', zh: '活動票券' },
    'pprom.records.source.projects': { en: 'Projects', zh: '項目' },
    'pprom.records.empty.title': { en: 'No discount records yet', zh: '尚無折抵紀錄' },
    'pprom.records.empty.text': { en: 'Orders that receive a platform threshold discount or platform code will show up here.', zh: '套用平台滿額折扣或平台優惠碼的訂單會顯示在這裡。' },
    'pprom.records.pc.col.creator': { en: 'Creator', zh: '藝人' },
    'pprom.records.pc.col.total': { en: 'Discount absorbed (period)', zh: '期間累計折抵' },
    'pprom.records.pc.col.orders': { en: 'Orders', zh: '訂單數' },
    ...
    /* 定時下架到期的自動連動通知（2026-09-18 · D288 裁決二）：靜態示範，對應 products-store 的 coaster／backstage-set */
    'notif.auto-unlist.title': { en: '“Kowloon After Dark coaster set” unlisted on schedule', zh: '「九龍夜行 杯墊組」已依排程下架' },
    'notif.auto-unlist.meta':  { en: '“Backstage tea set” includes it and was unlisted with it.', zh: '「後台茶水組」含這件商品，已一併下架。' },
    'notif.auto-unlist.time':  { en: 'Yesterday',             zh: '昨天' },
    ...
    /* 2026-08-28 拆成兩段：膠囊常駐只顯示百分比，對照期 hover 才展開（見 kpi.css）。 */
    /* 走勢圖標記區間的標籤沿用這一支（儀表板 4-up）。 */
    'ops.revenue-delta':      { en: '+12.6%',               zh: '+12.6%' },
    /* docs/ 的舊版儀表板探索頁仍用完整句的膠囊。 */
    'ops.revenue-delta-full': { en: '+12.6% vs last week',  zh: '較上週 +12.6%' },
    ...
    'spark.y.fans12':    { en: '1.2k',      zh: '1,200' },
    'spark.y.fans11':    { en: '1.1k',      zh: '1,100' },
    'spark.x.w9':        { en: '9w',        zh: '9 週' },
    'spark.x.w6':        { en: '6w',        zh: '6 週' },
    'spark.x.w3':        { en: '3w',        zh: '3 週' },
    ...
    'alert.event.desc':       { en: '<em>REALIVE World Tour (China) — Chongqing · Oct 25</em> still needs cancellation &amp; void policy and on-site staffing confirmed.', zh: '「<em>REALIVE World Tour (China) — 重慶站 · 10/25</em>」尚未確認取消與撤銷政策與現場人力配置。' },
    ...
    /* ── 待處理事項面板（2026-08-28）─────────────────────────────────
       細項名稱一律取自同一則 alert 的 desc 裡已經寫著的東西，不新造產品事實；
    ...
    'issue.ago.3h':               { en: '3 hours ago',               zh: '3 小時前' },
    'issue.ago.5h':               { en: '5 hours ago',               zh: '5 小時前' },
    'issue.ago.2d':               { en: '2 days ago',                zh: '2 天前' },
    'issue.ago.yesterday':        { en: 'Yesterday',                 zh: '昨天' },
    'alert.ip-rental.d1.name':    { en: 'Dragon Tiger Gate key art — brand license', zh: '龍虎門 主視覺 · 品牌授權' },
    'alert.ip-rental.d1.sub':     { en: 'Expires May 25',            zh: '25 May 到期' },
    ...
    'alert.event.d1.name':        { en: 'Cancellation & void policy', zh: '取消與撤銷政策' },
    ...
    'alert.spotify.d1.name':      { en: 'Spotify integration',       zh: 'Spotify 串接' },
    'alert.spotify.d1.sub':       { en: 'Sync stopped — ztor is on it', zh: '同步中斷，修復由 ztor 進行' },
    ...
    /* 2026-09-09（D253）：內容由「Payouts & refunds」改「Payouts & voids」——平台不再有
       退款動作，這顆篩選涵蓋的帳務異動改稱撤銷沖銷。 */
    'tx.filter.payouts':      { en: 'Payouts & voids',       zh: '提款與撤銷沖銷' },
    ...
    /* 墓碑（2026-09-09，D253）：tx.detail.refund-note 移除——平台不提供退款動作，
       earnings-ztor.html 的撤銷沖銷樣本列改用下方 tx.detail.void-note。 */
    'tx.detail.void-note':    { en: '<strong>Void write-off.</strong> Comes out of the void reserve first, then this period’s distributable profit, then carry forward — nothing already paid out is clawed back.', zh: '<strong>撤銷沖銷。</strong>依序由沖銷準備金、本期可分配淨利、再結轉赤字吸收；已經撥出去的款項不會被追回。' },
    ...
    /* 墓碑（2026-09-09，D253）：tx.cat.refund（原「Refund」／「退款」）移除——帳務異動
       分類改名「撤銷沖銷」，見下方 tx.cat.void。 */
    'tx.cat.void':            { en: 'Void',                  zh: '撤銷沖銷' },
    ...
    /* 墓碑（2026-09-09，D253）：tx.r.refund.qual（原「· 3 ticket refunds」／「· 退票 3 張」）
       移除——樣本列改為撤銷沖銷，見下方 tx.r.void.qual。 */
    'tx.r.void.qual':         { en: '· 3 tickets voided',    zh: '· 3 張票券撤銷' },
    ...
    /* 墓碑（2026-09-09，D253）：tx.detail.refund-note2 移除——平台不提供退款動作，
       earnings.html 的撤銷沖銷樣本列改用下方 tx.detail.void-note2；準備金同步更名沖銷準備金
       （Void Reserve，§7.3）。 */
    'tx.detail.void-note2':   { en: 'Void write-offs come out of the void reserve first, then this period\u2019s distributable profit, then carry forward \u2014 nothing already paid out is clawed back.', zh: '撤銷沖銷依序由沖銷準備金、本期可分配淨利、再結轉赤字吸收；已經撥出去的款項不會被追回。' },
    ...
    /* 磚列的區塊標題（2026-08-28）。刻意與下方表格的「近期活動與項目」不同名：
       磚列講的是「作品」（靠封面認人），表格講的是「紀錄」（靠欄位比較）；
       同屏兩個同名標題會讓人以為那是兩批東西。EN 用 in flight（在跑的東西），
       不是把中文逐字譯成 works in progress——後者在產品語境指未完成的草稿。 */
    /* 磚列的兩個分頁詞（2026-08-28）。標題本身就是切換，所以這兩個詞同時是
       區塊名稱與篩選值——必須夠短、且單看一個詞就知道在講什麼。
       中文「進行中／近期」把使用者原本說的「進行中的作品／近期作品」去掉共通的「作品」
       （整區都是作品，寫了是廢字）。英文不直譯：Active／Recent 是英文產品裡這個位置的慣用詞，
       In flight 雖然生動但對非母語讀者不夠直白。
       與下方表格那組（dash.tab.*）刻意分開：那組講的是活動紀錄，這組講的是作品。 */
    'rail.tab.active':        { en: 'Active',                zh: '進行中' },
    'rail.tab.recent':        { en: 'Recent',                zh: '近期' },
    'rail.more':              { en: 'More',                  zh: '更多' },
    'rail.prev':              { en: 'Previous',              zh: '上一頁' },
    'rail.next':              { en: 'Next',                  zh: '下一頁' },
    /* 封面磚上「已經上線了、日子是這一天」那一行（2026-08-28）。做成帶 {date} 的樣板
       而不是「日期 ＋ 固定後綴」：英文把動詞放前面（Released Aug…），中文放後面
       （…上線），拼接式必然有一邊語序是壞的。日期字串由 store 供應、樣板只負責語序。 */
    'work.released':          { en: 'Released {date}',       zh: '{date} 上線' },
    /* Trailing → 已從文字裡拿掉 — .card__head .card__link 會自動加 chevron::after。 */
    'dash.progress.link':      { en: 'View all',              zh: '查看全部' },
    /* 卡片列尾端開「進行中項目」彈窗的入口（2026-08-28）。刻意與上面那顆卡底
       「查看全部」（去 Projects 頁）用不同的字：兩個入口同時在一張卡上，
       同名會分不出誰去哪裡。這一個的落點是彈窗，字跟著彈窗的標題走
       （ops.modal.projects-title＝Active projects／進行中項目）。
       筆數不寫進句子，由旁邊那顆徽章承載，兩個語言都不必為語序改寫。 */
    ...
    /* 2026-09-09（D253）：Refund Reserve 改名沖銷準備金（Void Reserve，§7.3）——平台不提供
       退款動作，這裡吸收的是撤銷沖銷、不是退款本身；引用出處由 D041 改為 D253。 */
    ...
    'payouts.pool.reserve-meta':   { en: '0% withheld in v1 · whether voids need a reserve is proposed, pending approval (D253)', zh: 'v1 維持 0%（不預扣）· 撤銷沖銷是否需要預扣準備金為〔產品變更提案〕，待上游核准（D253）' },
    ...
    /* 店面分頁改欄位表單（2026-09-11 使用者：「全部改成欄位設定，像創建那樣；可編輯欄位參考粉絲端編輯個人檔案」） */
    'store-settings.sf.profile':       { en: 'Profile',                              zh: '個人檔案' },
    'store-settings.sf.profile.sub':   { en: 'The top of your fan page: photo, name, what you do, and a short bio.', zh: '粉絲頁最上面那一段：頭像、名字、身分、簡介。' },
    'store-settings.sf.avatar.change': { en: 'Change photo',                         zh: '變更相片' },
    'store-settings.sf.name':          { en: 'Display name',                         zh: '顯示名稱' },
    'store-settings.sf.name.ph':       { en: 'Your name on Ztor',                    zh: '你在 Ztor 上的名字' },
    'store-settings.sf.role':          { en: 'What you do',                          zh: '身分' },
    'store-settings.sf.role.hint':     { en: 'Shown under your name, e.g. Musician, Illustrator.', zh: '顯示在名字下方，例如：音樂人、插畫家。' },
    'store-settings.sf.role.ph':       { en: 'e.g. Musician',                        zh: '例如：音樂人' },
    'store-settings.sf.location':      { en: 'Location',                             zh: '所在地' },
    'store-settings.sf.location.hint': { en: 'Optional. Shown under your name, after what you do.',  zh: '選填，顯示在名字下方、身分之後。' },
    'store-settings.sf.location.ph':   { en: 'e.g. Tainan, Taiwan',                  zh: '例如：台灣台南' },
    'store-settings.sf.bio':           { en: 'Bio',                                  zh: '自我介紹' },
    'store-settings.sf.bio.ph':        { en: 'Tell fans who you are and what you make', zh: '告訴粉絲你是誰、在做什麼' },
    'store-settings.sf.url':           { en: 'Shop URL',                             zh: '商店網址' },
    'store-settings.sf.url.sub':       { en: 'Where fans find your shop. Letters, numbers and dashes only.', zh: '粉絲找到你的店的網址。只能用英文字母、數字與連字號。' },
    'store-settings.sf.social':        { en: 'Social links',                         zh: '社群連結' },
    'store-settings.sf.social.sub':    { en: 'Added links show as round buttons on your fan page. Your Ztor link is always first.', zh: '新增後會以圓鈕顯示在你的粉絲頁上；Ztor 那顆固定在最前面。' },
    'store-settings.sf.saved':         { en: 'Storefront saved',                     zh: '店面已儲存' },
    'social.add':                      { en: 'Add a social link',                    zh: '新增社群連結' },
    'social.remove':                   { en: 'Remove link',                          zh: '移除連結' },
    'social.url.ph':                   { en: 'Paste your {p} link',                  zh: '請輸入你的 {p} 連結' },
    'social.xiaohongshu':              { en: 'Xiaohongshu',                          zh: '小紅書' },
    'social.website':                  { en: 'Website',                              zh: '個人網站' },
    ...
    /* D272：欄名由「Sold」改「Used」——這欄現在顯示「已用／上限」（有上限）或「已用」（無上限），
       不再只是件數；已用歸零、複製列的邏輯見 store-settings.html discountCodes()。 */
    'store-settings.codes.col.sold':   { en: 'Used',             zh: '已用' },
    'store-settings.codes.col.applies': { en: 'Applies to',      zh: '範圍' },
    ...
    /* D272：狀態由四值增為五值——總兌換次數達上限後轉「已用完」，用 badge--warning（非 error，
       不是壞事，只是額度到了）。 */
    'store-settings.codes.status.exhausted': { en: 'Exhausted',  zh: '已用完' },
    ...
    /* ── F8.2 適用範圍（Applies to，D272）：三級可混選 ─────────────────────
       欄位標籤用完整的「適用範圍」，清單欄名收成「範圍」（見 col.applies）——
    ...
    'store-settings.codes.f.perorder.hint': { en: 'Leave empty or 0 for unlimited — the highest-priced qualifying items get the discount first.', zh: '留空或 0 不限；多件符合時折最貴的那幾件。' },
    'store-settings.codes.f.perbuyer': { en: 'Per buyer total',  zh: '每人總次數' },
    'store-settings.codes.f.perbuyer.hint': { en: 'Leave empty or 0 for unlimited, adding up across orders for the same ztor account.', zh: '留空或 0 不限，同一帳號跨訂單累計。' },
    'store-settings.codes.f.perbuyer.ph': { en: '0 = unlimited', zh: '0 ＝ 不限' },
    'store-settings.codes.f.total':    { en: 'Total redemptions', zh: '總兌換次數' },
    'store-settings.codes.f.total.hint': { en: 'Leave empty or 0 for unlimited. Once it runs out, the code’s status switches to Exhausted.', zh: '留空或 0 不限；用完轉已用完。' },
    'store-settings.codes.f.fixedmode': { en: 'Fixed-amount split', zh: '固定金額折法' },
    'store-settings.codes.f.fixedmode.hint': { en: 'When multiple items qualify, whether the fixed amount discounts once for the order or once per item.', zh: '多件符合時，固定金額折一次還是每件都折。' },
    'store-settings.codes.f.fixedmode.once': { en: 'Once per order (default)', zh: '整單只折一次（預設）' },
    'store-settings.codes.f.fixedmode.each': { en: 'Once per item', zh: '每件各折一次' },
    'store-settings.codes.f.stack':    { en: 'Stack with other codes', zh: '可與其他優惠碼疊加' },
    'store-settings.codes.f.stack.hint': { en: 'Both codes need this on to combine in one order — if either is off, only the one better for the buyer applies.', zh: '兩組碼都開啟才能同一單並用；任一關閉就擇一，取對買家最有利。' },
    ...
    'e-shop.col.shown':         { en: 'Shown',                             zh: '顯示' },
    'e-shop.shown.show-title':  { en: 'Show “{n}” in your shop?',          zh: '要在商店顯示「{n}」嗎？' },
    'e-shop.shown.show-body':   { en: 'It goes back on the storefront; its private link stops working.', zh: '它會回到商店陳列，原本的非公開連結撤銷。' },
    'e-shop.shown.hide-title':  { en: 'Hide “{n}” from your shop?',        zh: '要在商店隱藏「{n}」嗎？' },
    'e-shop.shown.hide-body':   { en: 'Fans won’t find it in the shop. Anyone with the private link can still buy it, and bundles that include it keep selling.', zh: '粉絲在商店找不到它；持非公開連結的人仍可購買，含它的組合包也照樣賣。隱藏不等於下架。' },
    'e-shop.shown.confirm':     { en: 'Confirm',                           zh: '確認' },
    ...
    /* 下架確認與組合包連動（2026-09-18 · D288，§7.14「下架確認與組合包連動」）：三種販售管道的下架都先確認；
       單售仍在上架中組合包裡時列出組合包、主鈕「一同下架這些組合包」。組合包重新上架擋下＝列出未上架成員、只有一顆「知道了」。 */
    'e-shop.unlist.title':      { en: 'Unlist “{n}”?',                     zh: '要下架「{n}」嗎？' },
    /* D290（2026-09-18）：下架清四個排程時間、開賣退回未開賣——彈窗多一句讓人知道重新上架後要再設開賣 */
    'e-shop.unlist.body':       { en: 'Public and private links stop working and fans no longer see its page. Listing and sale schedules are cleared; set the sale again after relisting.', zh: '公開與非公開連結都會失效，粉絲端不再有它的頁面。下架會清除上架與開賣排程，重新上架後需再設定開賣。' },
    'e-shop.unlist.confirm':    { en: 'Unlist',                            zh: '下架' },
    ...
    /* 零成交可刪除（2026-09-22，D307，§7.14「封存與刪除」）：已下架／已封存且零成交的單售、組合包、拍賣——清單 kebab 與細節頁頁首的「刪除」。
       標題帶品名、內文講不可復原；組合包另一句講不影響成員；單售仍在組合包裡的擋下沿用 `e-shop.relist.blocked-ok`（知道了）當唯一主鈕。 */
    'e-shop.remove.title':      { en: 'Delete “{n}”?',                     zh: '要刪除「{n}」嗎？' },
    'e-shop.remove.body':       { en: 'It disappears from every list and filter. This cannot be undone.', zh: '它會從所有清單與篩選消失，刪除後無法復原。' },
    'e-shop.remove.bundle-body': { en: 'Members keep their status and stock. This cannot be undone.', zh: '成員商品的狀態與庫存不受影響，刪除後無法復原。' },
    'e-shop.remove.blocked-title': { en: '“{n}” is still in bundles',      zh: '「{n}」仍在組合包裡' },
    'e-shop.remove.blocked-body':  { en: 'Remove it from these bundles first, then delete:', zh: '先到這些組合包把它移除，才能刪除：' },
    ...
    /* 2026-09-11 組合列成員說明改由 products-store 的 ztorGetBundle() 組出「成員名 + … · N 件」，件數那段走這個 key */
    'e-shop.bundle.members.n':    { en: '{n} items', zh: '{n} 件' },
    /* 2026-09-11 nick persona 的數位商品列（從實體列複製）規格副標，依內容形態 */
    'e-shop.meta.digital.song':       { en: 'Single · instant download',         zh: '單曲 · 購買後立即下載' },
    'e-shop.meta.digital.video':      { en: 'Video · stream / download',         zh: '影片 · 串流／下載' },
    'e-shop.meta.digital.album':      { en: 'Album · download with lyrics',      zh: '專輯 · 下載附歌詞' },
    'e-shop.meta.digital.membership': { en: 'Membership · recurring',            zh: '會員卡 · 定期訂閱' },
    'e-shop.meta.digital.document':   { en: 'Document · PDF',                    zh: '文件 · PDF' },
    'e-shop.meta.digital.ip':         { en: 'IP assets · licence pack',          zh: 'IP 素材 · 授權包' },
    ...
    'shop.status.draft':           { en: 'Draft',                              zh: '草稿' },   /* 2026-09-11 使用者：「未完成應該是草稿」，對齊 §7.2 狀態名 */
    ...
    'e-shop.status.draft':    { en: 'Draft',                               zh: '草稿' },   /* 2026-09-11 同 shop.status.draft：拍賣草稿也叫草稿 */
    ...
    'fan.profile.default.location': { en: 'Tainan, Taiwan',                      zh: '台灣台南' },
    'fan.profile.nick.location':    { en: 'Taipei, Taiwan',                      zh: '台灣台北' },
    ...
    /* 2026-09-18（D287）流標示範列：結標但無人出價 */
    'e-shop.a7.name':         { en: 'Tour enamel pin set',                  zh: '巡演琺瑯別針組' },
    'e-shop.a7.meta':         { en: 'New · All fans',                       zh: '全新 · 全部粉絲' },
    'e-shop.a7.bid':          { en: 'From $65',                             zh: '起標 $65' },
    'e-shop.a7.activity':     { en: '0 bids · No winner',                   zh: '0 次出價 · 無人得標' },
    /* a8（2026-09-22，D307 示範）：流標後下架、從未有出價的拍賣——已下架且零出價 → 可刪除；activity 沿用 a7 那句 */
    'e-shop.a8.name':         { en: 'Handwritten setlist sheet',            zh: '手寫演出曲目單' },
    'e-shop.a8.meta':         { en: 'Good · All fans',                      zh: '良好 · 全部粉絲' },
    'e-shop.a8.bid':          { en: 'From $120',                            zh: '起標 $120' },
    ...
    'e-shop.a.openevent':     { en: 'Open event page',                     zh: '前往活動頁' },   /* 活動組合包列（D292／D294） */
    ...
    'e-shop.astatus.unsold':  { en: 'Unsold',                              zh: '流標' },   /* 2026-09-18 D287：結標時無人出價，與 ended（完售）同層的新桶 */
    ...
    /* 2026-09-11 示範資料補齊計劃 §1/§2/§3/§4：新增單售商品與組合列的介面文案（doc-guide/ip-kit/
       poster/jacket/tote/keychain/beanie/wristband 與 signing-set 等新組合），供 e-shop 清單顯示用。 */
    'e-shop.rowDocGuide.meta': { en: 'PDF · behind-the-scenes notes', zh: 'PDF · 拍攝側記' },
    'e-shop.rowDocGuide.cat': { en: 'Document', zh: '文件' },
    'e-shop.rowDocGuide.price': { en: '$6.00', zh: '$6.00' },
    'e-shop.rowDocGuide.stock': { en: '∞', zh: '∞' },
    'e-shop.rowIpKit.meta': { en: 'IP kit · brand assets', zh: 'IP 授權 · 視覺素材' },
    'e-shop.rowIpKit.cat': { en: 'IP kit', zh: '視覺素材' },
    'e-shop.rowIpKit.price': { en: '$18.00', zh: '$18.00' },
    'e-shop.rowPoster.meta': { en: 'Numbered 1/100', zh: '編號限定 1/100' },
    'e-shop.rowPoster.cat': { en: 'Posters', zh: '海報' },
    'e-shop.rowPoster.price': { en: '$45.00', zh: '$45.00' },
    'e-shop.rowPoster.stock': { en: '3 / 100', zh: '3 / 100' },
    'e-shop.rowJacket.meta': { en: 'Colour (Black/Olive) × Size (S/M/L)', zh: '顏色（黑／橄欖）× 尺寸（S/M/L）' },
    'e-shop.rowJacket.cat': { en: 'Apparel', zh: '服飾' },
    'e-shop.rowJacket.price': { en: '$88.00', zh: '$88.00' },
    'e-shop.rowJacket.stock': { en: '19 / 30', zh: '19 / 30' },
    'e-shop.rowTote.cat': { en: 'Merch', zh: '周邊商品' },
    'e-shop.rowTote.price': { en: '$28.00', zh: '$28.00' },
    'e-shop.rowTote.stock': { en: '40 / ∞', zh: '40 / ∞' },
    ...
    'e-shop.rowPostcard.stock': { en: '58 / 150', zh: '58 / 150' },
    ...
    /* 2026-09-18 D288 示範列：定時下架已到期的杯墊組 */
    'e-shop.rowCoaster.cat': { en: 'Merch', zh: '周邊商品' },
    'e-shop.rowCoaster.price': { en: '$11.00', zh: '$11.00' },
    'e-shop.rowCoaster.stock': { en: '40 / ∞', zh: '40 / ∞' },
    ...
    'e-shop.rowBeanie.stock': { en: '0 / ∞', zh: '0 / ∞' },
    'e-shop.rowWristband.meta': { en: 'Size (S/M/L)', zh: '尺寸（S/M/L）' },
    'e-shop.rowWristband.cat': { en: 'Collectibles', zh: '收藏品' },
    'e-shop.rowWristband.price': { en: '$22.00', zh: '$22.00' },
    'e-shop.rowWristband.stock': { en: '60 / ∞', zh: '60 / ∞' },
    'e-shop.bSigning.members': { en: 'Acetate + wristband + jacket + zine · 4 items', zh: '黑膠＋手環＋外套＋雜誌書 · 4 件' },
    'e-shop.bSigning.price': { en: '$252.00', zh: '$252.00' },
    'e-shop.bSigning.stock': { en: '20 left (min)', zh: '剩 20 件（取最少）' },
    'e-shop.bNeon.members': { en: 'Pin + sticker · 2 items', zh: '徽章＋貼紙包 · 2 件' },
    'e-shop.bNeon.price': { en: '$0.00', zh: '$0.00' },
    'e-shop.bNeon.stock': { en: '0 left (min)', zh: '剩 0 件（取最少）' },
    'e-shop.bWinter.members': { en: 'Hoodie + cap · 2 items', zh: '連帽外套＋六片帽 · 2 件' },
    'e-shop.bWinter.price': { en: '$71.00', zh: '$71.00' },
    'e-shop.bWinter.stock': { en: '100 left (min)', zh: '剩 100 件（取最少）' },
    'e-shop.bTour.members': { en: 'Tee + zine · 2 items', zh: 'T 恤＋雜誌書 · 2 件' },
    'e-shop.bTour.price': { en: '$52.00', zh: '$52.00' },
    'e-shop.bTour.stock': { en: '0 left (min)', zh: '剩 0 件（取最少）' },
    'e-shop.bInternal.members': { en: 'Cap + shoes · 2 items', zh: '六片帽＋低筒鞋 · 2 件' },
    'e-shop.bInternal.price': { en: '$82.00', zh: '$82.00' },
    'e-shop.bInternal.stock': { en: '0 left (min)', zh: '剩 0 件（取最少）' },
    'e-shop.bNickSigning.members': { en: 'Vinyl + WYAGL tee + 24CE jersey · 3 items', zh: '黑膠＋祝你好命 T＋24CE 球衣 · 3 件' },
    'e-shop.bNickSigning.price': { en: '$258.00', zh: '$258.00' },
    'e-shop.bNickSigning.stock': { en: '30 left (min)', zh: '剩 30 件（取最少）' },
    'e-shop.bNickVinyl.members': { en: 'Vinyl + WYAGL tee · 2 items', zh: '黑膠＋祝你好命 T · 2 件' },
    'e-shop.bNickVinyl.price': { en: '$168.00', zh: '$168.00' },
    'e-shop.bNickVinyl.stock': { en: '15 left (min)', zh: '剩 15 件（取最少）' },
    'e-shop.bNickSoldout.members': { en: 'Pillow + Dupont bag · 2 items', zh: '抱枕＋Dupont 提袋 · 2 件' },
    'e-shop.bNickSoldout.price': { en: '$0.00', zh: '$0.00' },
    'e-shop.bNickSoldout.stock': { en: '0 left (min)', zh: '剩 0 件（取最少）' },
    'e-shop.bNickPreorder.members': { en: 'Hoodie + cap · 2 items', zh: '連帽外套＋帽子 · 2 件' },
    'e-shop.bNickPreorder.price': { en: '$95.00', zh: '$95.00' },
    'e-shop.bNickPreorder.stock': { en: '100 left (min)', zh: '剩 100 件（取最少）' },
    'e-shop.bNickRecap.members': { en: 'T-shirt (white) + socks · 2 items', zh: 'T 恤（白）＋襪子 · 2 件' },
    'e-shop.bNickRecap.price': { en: '$48.00', zh: '$48.00' },
    'e-shop.bNickRecap.stock': { en: '0 left (min)', zh: '剩 0 件（取最少）' },
    'e-shop.bNickInternal.members': { en: 'Cap + sneakers · 2 items', zh: '帽子＋球鞋 · 2 件' },
    'e-shop.bNickInternal.price': { en: '$110.00', zh: '$110.00' },
    'e-shop.bNickInternal.stock': { en: '0 left (min)', zh: '剩 0 件（取最少）' },
    ...
    /* 編輯彈窗的「各選項組合價格與庫存」區副標：庫存不能直接改，不沿用建立頁那句（2026-09-21 起限量商品多一欄上限，由表頭自己說明）。 */
    ...
    /* 庫存版本 Edition（2026-09-21，spec 5.1.5.1 §2.10／§7.2）：建立後鎖定只呈現；上限可改但不得低於已售 */
    'product-detail.edition.sub':        { en: 'Fixed after creation — the cap can still change, but never below what\'s sold.', zh: '建立後不可切換；上限仍可改，但不得低於已售數。' },
    'product-detail.edition.sold':       { en: '{n} sold',                                    zh: '已售 {n}' },
    'product-detail.edition.cap-err':    { en: 'Can\'t be lower than units sold ({n})',       zh: '不可低於已售數（{n}）' },
    'product-detail.edition.cap-err-row': { en: '{v}: can\'t be lower than units sold ({n})', zh: '{v}：不可低於已售數（{n}）' },
    'product-detail.edition.multi-hint': { en: 'Caps are set per variation in the pricing table below.', zh: '各選項組合的上限在下方定價表填寫。' },
    'product-detail.setov.edition.limited-total': { en: 'Limited · {n} total',    zh: '限量 · 上限 {n}' },
    'product-detail.setov.edition.per-variant':   { en: 'Limited · per variation', zh: '限量 · 逐選項設定' },
    ...
    'stock.dest.title':             { en: 'Bundles',            zh: '組合包' },
    'stock.dest.sub':               { en: 'Bundles that include this product and how many units each locks; locks are set on the bundle.', zh: '用到這件商品的組合包，以及各自從它鎖走幾件；鎖定量在組合包詳情設定。' },
    ...
    'stock.history.sub':            { en: 'One row per restock order or lock change — open a row for details.', zh: '一張補貨單或一次鎖定一筆，點開看明細。' },
    ...
    'stock.history.k.note':         { en: 'Note',               zh: '備註' },
    'stock.history.own':            { en: 'Own stock',          zh: '自有庫存' },
    ...
    'product-detail.sales.more':    { en: 'View in Earnings',   zh: '到收入管理查看' },
    ...
    'product-detail.ref.label':     { en: 'Projects',      zh: '項目' },
    ...
    'product-detail.tab.links':       { en: 'Links',           zh: '關聯' },
    'product-detail.kpi.links':       { en: 'In use',          zh: '關聯中' },
    'kpi.links-meta.bundles':         { en: '{n} bundles',  zh: '{n} 個組合包' },
    ...
    'product-detail.var.listed':    { en: 'Listed',                               zh: '上架中' },
    ...
    'bd.pickup.sub':        { en: 'After checkout, members with on-site QR pickup expand into their own pickup units — the bundle itself issues no pickup code. Each unit is tagged “from bundle {name}”, and its pickup session follows that member’s own setting.', zh: '下單後，含現場 QR 領取的成員會展開為各自的領取單位；組合本身不產生領取碼，成員的領取單位會標記「來自組合「{name}」」，取貨場次沿用該成員商品自己的設定。' },
    'bd.pickup.member-meta': { en: 'On-site QR pickup',       zh: '現場 QR 領取' },
    ...
    'cb.edition.sub':       { en: 'Unlimited sells while members have stock; Limited adds a hard cap on top.', zh: '不限量＝成員有貨就賣；限量＝在成員庫存之上再設一個硬上限。' },
    'cb.add-item':          { en: 'Add',                     zh: '加入' },
    'cb.remove':            { en: 'Remove',                  zh: '移除' },
    'bd.pick.noresult':     { en: 'No products match.',      zh: '沒有符合的商品。' },
    /* 2026-09-11 組合包詳情頁重組（對齊商品詳情）：四分頁、頁首小字、組合庫存 KPI、鎖定歷史、組合設定 */
    'bd.tab.stock':         { en: 'Bundle stock',            zh: '組合庫存' },
    'bd.tab.settings':      { en: 'Bundle settings',         zh: '組合設定' },
    'bd.hero.items':        { en: 'items',                   zh: '個成員' },   /* 2026-09-18 D292：成員含活動票券，計數詞由「件商品」改「個成員」 */
    ...
    /* 因成員下架而一同下架、成員已封存／已下架（2026-09-18 · D284 → D288 改文案：連動點從封存移到下架，key 沿用）
       reason-auto＝成員定時下架到期的自動連動（unlistReason.auto）。 */
    'bd.unlist.reason':     { en: 'Unlisted together with “{n}”. Relisting the bundle relists that item with it.', zh: '因成員「{n}」下架而一同下架；重新上架組合包時會一起重新上架該商品。' },
    'bd.unlist.reason-auto': { en: '“{n}” was unlisted on schedule, so this bundle was unlisted with it. Relisting the bundle relists that item with it.', zh: '成員「{n}」已依排程下架，本組合一併下架；重新上架組合包時會一起重新上架該商品。' },
    'bd.member.archived':   { en: '“{n}” is archived — the bundle cannot sell', zh: '成員「{n}」已封存，組合不可售' },
    'bd.member.unlisted':   { en: '“{n}” is unlisted — the bundle cannot sell', zh: '成員「{n}」已下架，組合不可售' },
    ...
    'product-detail.kpi.links-meta-items': { en: '{n} items', zh: '{n} 個成員' },   /* 2026-09-18 D292：組合設定概覽的成員列同上 */
    ...
    /* 2026-09-18（D287）流標結果列：右欄競標狀態卡，結標無出價時才顯示（見 auction-detail.html data-ad-unsold-row） */
    'ad.info.result':       { en: 'Result',                  zh: '結果' },
    'ad.result.unsold':     { en: 'Unsold — no bids',        zh: '流標 · 無人出價' },
    ...
    /* 墓碑 2026-09-18（D281）：刪除活動鈕退場，下面兩鍵零消費、值保留。 */
    'event-detail.edit.confirm-delete': { en: 'Delete this event? {n} people hold tickets — void them individually or all at once first.', zh: '確定刪除這場活動？已有 {n} 人持票，需先逐票或整場撤銷。' },
    ...
    /* 2026-09-18（D281、5.1.6.2 F1）：類型「建立後即鎖死」，與是否開賣無關——原文「開賣後不可更改」改寫。
       消費者：event-detail.html 設定分頁類型列的 .field__hint（編輯態才顯示）。 */
    'ee.ov.type.locked':  { en: 'Locked after creation — the rest of the form depends on it. To change it, create a new event.', zh: '建立後不可更改——下方欄位都由它決定。要換類型請另建一場。' },
    ...
    'event-detail.tx.cancelled-meta': { en: 'Voided — returned to inventory', zh: '已撤銷 · 已退回庫存' },
    ...
    'event-detail.tx.void': { en: 'Void', zh: '撤銷' },
    ...
    /* 墓碑 2026-09-18（D281）：活動不可刪除、只可取消。ee.delete／ee.delete.confirm／ee.delete.confirm.sold
       三鍵的消費者（event-detail.html 頁首 `data-ed-delete` 鈕與其 confirm()）已退場，值保留不消費。 */
    ...
    /* 2026-09-09（D253）：原文「would be refunded／將辦理退款」與現行政策矛盾——平台不提供
       退款動作，已售票的活動要刪除得先逐票或整場撤銷。此 key 目前零畫面消費，改對文案
       是為了將來被接回去用時不會沿用錯誤承諾。 */
    'ee.delete.confirm.sold': { en: 'Delete this event? {n} people hold tickets — void them first, one by one or all at once. Deleting does not refund anyone. This cannot be undone.', zh: '確定刪除這場活動？有 {n} 人持票，請先逐票或整場撤銷。刪除不會退款給任何人，且無法復原。' },
    ...
    'settings.sub':             { en: 'Account &amp; sign-in, look &amp; feel, language, notifications, privacy, payments, and connected platforms.', zh: '帳戶與登入方式、外觀、語言、通知、隱私、付款，以及第三方平台連結。' },
    'settings.btn.discard':     { en: 'Discard',                              zh: '放棄' },
    'settings.btn.save':        { en: 'Save changes',                         zh: '儲存變更' },
    'settings.nav.profile':         { en: 'Profile',              zh: '個人檔案' },
    ...
    /* settings.profile.* 2026-09-14 重整（D269）：粉絲可見欄位（頭像／名稱／簡介／使用者名稱／網站／所在地）併入 store-settings 店面，
       這一組只剩帳戶層的聯絡方式（同日補裁決） */
    'settings.profile.title':       { en: 'Profile',              zh: '個人檔案' },
    'settings.profile.sub':         { en: 'Your account and how you sign in. Fans never see these; what fans see lives in Store settings › Storefront.', zh: '你的帳戶與登入方式，粉絲看不到；粉絲看到的身分在商店設定 › 店面。' },
    'settings.profile.nickname':    { en: 'Nickname',             zh: '暱稱' },
    'settings.profile.nickname-hint':{ en: 'Same as your storefront display name.', zh: '與店面的顯示名稱是同一個。' },
    'settings.profile.edit-in-store':{ en: 'Edit in Storefront',  zh: '到店面修改' },
    'settings.profile.realname':    { en: 'Legal name',           zh: '真實姓名' },
    'settings.profile.realname-hint':{ en: 'Verified through identity verification (KYC).', zh: '經身分驗證（KYC）確認。' },
    'settings.profile.unverified':  { en: 'Not verified',         zh: '未驗證' },
    'settings.profile.verify':      { en: 'Verify',               zh: '驗證' },
    'settings.profile.realname-en': { en: 'English name',         zh: '英文姓名' },
    'settings.profile.after-verify':{ en: 'Shown after verification', zh: '驗證後顯示' },
    'settings.profile.first-name':  { en: 'First name',           zh: '名' },
    'settings.profile.last-name':   { en: 'Last name',            zh: '姓' },
    'settings.profile.close':       { en: 'Close',                zh: '關閉' },
    'settings.profile.cancel':      { en: 'Cancel',               zh: '取消' },
    'settings.profile.email-modal.title':   { en: 'Change email',     zh: '變更 Email' },
    'settings.profile.email-modal.current': { en: 'Current',          zh: '目前' },
    'settings.profile.email-modal.new':     { en: 'New email',        zh: '新的 Email' },
    'settings.profile.email-modal.hint':    { en: 'Notifications switch to the new address once saved.', zh: '儲存後通知改寄到新信箱。' },
    'settings.profile.phone-modal.title':   { en: 'Link phone',       zh: '綁定電話' },
    'settings.profile.phone-modal.hint':    { en: 'Once linked you can sign in with it.', zh: '綁定後可以用它登入。' },
    'settings.profile.password-modal.title':   { en: 'Change password',     zh: '變更密碼' },
    'settings.profile.password-modal.current': { en: 'Current password',    zh: '目前密碼' },
    'settings.profile.password-modal.new':     { en: 'New password',        zh: '新密碼' },
    'settings.profile.password-modal.hint':    { en: 'Strength shows as you type.', zh: '輸入時即時顯示強度。' },
    'settings.profile.password-modal.confirm': { en: 'Confirm new password', zh: '再輸入一次新密碼' },
    'settings.profile.unlinked':    { en: 'Not linked',           zh: '未綁定' },
    'settings.profile.link-phone':  { en: 'Link phone',           zh: '綁定' },
    'settings.profile.sso':         { en: 'Third-party sign-in',  zh: '第三方登入' },
    'settings.profile.link':        { en: 'Link',                 zh: '連結' },
    'settings.profile.unlink':      { en: 'Unlink',               zh: '解除連結' },
    'settings.profile.email':       { en: 'Email',                zh: 'Email' },
    'settings.profile.email-hint':  { en: 'Account &amp; transactional notifications.', zh: '帳戶與交易通知。' },
    'settings.profile.phone':       { en: 'Phone',                zh: '電話' },
    'settings.profile.phone-hint':  { en: 'Optional. Once linked you can sign in with it.', zh: '選填。綁定後可以用它登入。' },
    ...
    /* D305／D306（2026-09-22）：詳情頁再開同一層（mode:'save'）、幣別軸、兩張表、活動的可翻譯欄位擴列 */
    'pp.modal-title-save':  { en: 'Preview & localization',          zh: '預覽與在地化' },
    'pp.save':              { en: 'Save',                             zh: '儲存' },
    'pp.back-save':         { en: 'Cancel',                           zh: '取消' },
    'pp.currency-label':    { en: 'Currency',                         zh: '幣別' },
    'pp.table.translations':{ en: 'Translations',                     zh: '翻譯' },
    'pp.table.prices':      { en: 'Prices',                           zh: '價格' },
    'pp.table.prices-hint': { en: 'Base currency is read-only — change the price in the form. Other currencies are converted; type a number to override.', zh: '基準幣別唯讀，要改回原欄位改。其餘幣別是換算值，直接輸入數字即覆寫。' },
    ...
    'fep.crumb.events':     { en: 'Events',                           zh: '活動' },
    'fep.organizer':        { en: 'Organizer',                        zh: '主辦' },
    'fep.date':             { en: 'Date',                             zh: '日期' },
    'fep.time':             { en: 'Time',                             zh: '時間' },
    'fep.duration':         { en: 'Length',                           zh: '時長' },
    'fep.venue':            { en: 'Venue',                            zh: '場館' },
    'fep.language':         { en: 'Language',                         zh: '語言' },
    'fep.priority':         { en: 'Early access',                     zh: '優先購' },
    'fep.limit':            { en: 'Per order',                        zh: '限購' },
    'fep.tiers.n':          { en: '{n} ticket types',                 zh: '{n} 種票' },
    'fep.bundles.n':        { en: '{n} bundles',                      zh: '{n} 組組合方案' },
    'fep.link.bundles':     { en: 'Bundles',                          zh: '組合方案' },
    'fep.link.ticket':      { en: 'Tickets only',                     zh: '只買票' },
    ...
    'fep.related.note':     { en: 'Placeholder',                      zh: '示意' },
    'fep.related.badge':    { en: 'Not this event',                   zh: '非本活動' },
    'fep.status.on-sale':   { en: 'On sale',                          zh: '售票中' },
    'fep.status.soon':      { en: 'Coming soon',                      zh: '即將開賣' },
    'fep.status.ended':     { en: 'Ended',                            zh: '已結束' },
    'fep.status.cancelled': { en: 'Cancelled',                        zh: '已取消' },
    'fep.pickup.eticket':   { en: 'E-ticket (QR)',                    zh: '電子門票（QR）' },
    'fep.pickup.sf':        { en: 'SF Express delivery',              zh: '順豐寄送' },
    ...
    'ed.loc.langs':         { en: 'Translations',                     zh: '翻譯' },
    'ed.loc.langs.val':     { en: '4 languages · auto-generated, editable', zh: '4 語系 · 自動生成、可改' },
    'ed.loc.base':          { en: 'Base currency',                    zh: '基準幣別' },
    'ed.loc.overrides':     { en: 'Currency overrides',               zh: '幣別覆寫' },
    ...
    /* ✝ 墓碑 · 'pp.mock.pickup-exchange-body'（2026-09-18 D291 退役）：預覽 mock 的取貨與退換段改吃 F4「取貨與退貨說明」欄的值（cp.delivery.returns），固定假文不再需要。 */
    ...
    'ce.dup.note': { en: 'Copied from {name} — name, description, images and ticket types came along. Dates, venue and sales figures start fresh.', zh: '已從「{name}」複製：名稱、說明、圖片與門票設定跟著過來，日期、場地與銷售數字重新開始。' },
    ...
    'cp.dsub.ip':           { en: 'IP assets',                 zh: 'IP 素材' },
    ...
    /* 未開拍（2026-09-18 · D290）：拍賣細節頁開拍方式的第三項，下架後、重新上架後停在這裡；ad.unlist.body 是拍賣版的下架確認內文 */
    'ca.start.off':        { en: 'Not started',                     zh: '未開拍' },
    'ca.start.off-sub':    { en: 'Bidding stays closed until you set a start', zh: '出價未開放，設定開拍後才會開始' },
    'ad.sale.relist-note': { en: 'Relisted without a start — set one to open bidding.', zh: '重新上架後未開拍，請設定開拍。' },
    'ad.unlist.body':      { en: 'Public and private links stop working and fans no longer see its page. Listing schedule and start time are cleared; set the start again after relisting.', zh: '公開與非公開連結都會失效，粉絲端不再有它的頁面。下架會清除上架排程與開拍時間，重新上架後需再設定開拍。' },
    ...
    /* 2026-09-04 D249：選項建構器的兩顆快捷（尺寸／顏色）＋顏色值的色號欄 */
    'cp.var.preset.size':   { en: 'Size',                             zh: '尺寸' },
    'cp.var.preset.colour': { en: 'Color',                            zh: '顏色' },
    ...
    /* 2026-09-18 D291：取貨與退貨說明——物流配送／現場 QR 領取共用一格，顯示在買家端商品頁「取貨與退換」段 */
    'cp.delivery.returns':      { en: 'Pickup & returns', zh: '取貨與退貨' },
    'cp.delivery.returns.hint': { en: 'Shown on the product page for both shipping and on-site pickup. Optional — leave blank to hide the section.', zh: '顯示在商品頁，物流配送與現場 QR 領取都會出現。選填，留空時商品頁不顯示這一段。' },
    'cp.delivery.returns.ph':   { en: 'e.g. Ready within 3–5 business days. Exchanges accepted within 7 days of delivery, unworn and with tags attached.', zh: '例：3–5 個工作天內備妥。到貨 7 天內、未拆標籤可辦理退換。' },
    ...
    /* 未開賣（2026-09-18 · D290）：細節頁開賣二選一多出的第三項——下架後、重新上架後都停在這一項；
    ...
    'cp.listing.sales-note':    { en: 'Has sales — archive only.',        zh: '已有銷售紀錄，只能封存。' },   /* D307：已下架／已封存但有成交，說明為什麼沒有「刪除」 */
    ...
    /* 2026-09-04 D248：預覽改成粉絲端商品頁的鏡像，多出來的三支文案 */
    'cp.pv.cat':            { en: 'Category',                          zh: '分類' },
    'cp.pv.add':            { en: 'Add to cart',                       zh: '加入購物車' },
    'cp.pv.qr':             { en: 'On-site QR pickup',                 zh: '現場 QR 領取' },
    ...
    'cb.kind.product':      { en: 'Products',                         zh: '商品' },
    'cb.kind.ticket':       { en: 'Event tickets',                    zh: '活動票券' },
    'cb.qty.label':         { en: 'Quantity per set',                 zh: '每套用量' },
    'cb.tix.recent':        { en: 'Recently viewed events',           zh: '近期瀏覽的活動' },
    'cb.tix.search.ph':     { en: 'Search your events…',              zh: '搜尋你的活動…' },
    'cb.tix.noresult':      { en: 'No events match.',                 zh: '沒有相符的活動。' },
    'cb.tix.detail':        { en: 'Open event in a new tab',          zh: '開新分頁看活動詳情' },
    'cb.tix.one-event':     { en: 'One event per bundle',             zh: '一組只含一場活動的票' },
    'cb.tix.tiers-of':      { en: 'Ticket tiers ·',                   zh: '票種 ·' },
    'cb.tix.change':        { en: 'Change event',                     zh: '換一場活動' },
    'cb.tix.notiers':       { en: 'This event has no ticket tiers yet.', zh: '這場活動還沒有票種。' },
    'cb.tix.left':          { en: '{n} left',                         zh: '剩 {n} 張' },
    'cb.tix.unit':          { en: 'tickets',                          zh: '張' },
    'cb.tix.qty':           { en: 'Tickets per set',                  zh: '每套張數' },
    'cb.tix.added':         { en: 'Added',                            zh: '已加入' },
    'cb.tix.each-qr':       { en: 'each ticket has its own QR',       zh: '每張各自 QR、各自報到' },
    /* 2026-09-21（D296）：挑活動 → 勾允許票種（可多勾）→ 張數 n → 加入為一筆票券成員 */
    'cb.tix.pick-hint':     { en: 'Check the tiers fans can pick from; fans get that many tickets of the one they choose.', zh: '勾選粉絲可以挑的票種；粉絲挑一種，拿到該票種 × 張數。' },
    'cb.tix.add-member':    { en: 'Add as ticket member',             zh: '加入為票券成員' },
    'cb.tix.none-checked':  { en: 'Check at least one tier',          zh: '至少勾選一種票種' },
    'cb.tix.one-member':    { en: 'This bundle already has a ticket member — remove it to pick again.', zh: '這個組合已有票券成員，要改先移除。' },
    'cb.tix.left-of':       { en: '{name} {n} left',                  zh: '{name} 剩 {n} 張' },
    ...
    'cb.qty.col':           { en: 'Per set',                          zh: '每組' },
    'cb.why.name':          { en: 'Name it first',                    zh: '先填名稱' },
    'cb.why.disc':          { en: 'Discount must be 0–100',           zh: '折扣須為 0–100' },
    'cb.why.cap':           { en: 'Limited needs a cap',              zh: '限量要填上限' },
    'cb.why.sale':          { en: 'Finish the limited-time discount (%, start, end)', zh: '限時折扣的 %、起訖日還沒填齊' },
    'cb.why.listing-time':  { en: 'Scheduled listing needs a time',   zh: '定時上架要填時間' },
    'cb.note.tickets':      { en: "Includes event tickets — each set draws its tickets from the tier's own pool, and every ticket gets its own QR and check-in.", zh: '含活動票券：每賣一套就從該票種的數量池扣掉張數（與單賣票共用），每張票各自一個 QR、各自報到。' },
    'cb.fee.ticket-rate':   { en: 'Includes event tickets — the platform fee follows the event ticket rate for the whole bundle, not split by member.', zh: '含活動票券：平台費整筆依活動票務費率計，不拆成員分攤。' },
    'cb.follow-event':      { en: 'Follows the event “{name}” ({status}): stays a draft until the event is published, lists and goes on sale with it, and is unlisted if the event is cancelled or unlisted.', zh: '跟著活動「{name}」（{status}）：活動未發布時本組合為草稿，隨活動上架與開賣；活動取消或下架時一同下架。' },
    'bd.members.ticket-note': { en: "Ticket members draw from the tier's own pool — each set sold takes its tickets from the tier. Every ticket gets its own QR and checks in on its own.", zh: '票券成員與單賣票共用同一個票種數量池，每賣一套就從該票種扣掉張數；每張票各自一個 QR、各自報到。' },
    'bd.members.locked':    { en: '{n} sold — members and quantities are locked. You can still change the price, discount, cap and sale; to change what is inside, create a new bundle.', zh: '已售出 {n} 套，成員與數量已鎖定。仍可改售價、折扣、販售上限與停售；要換內容請另建新組、停售這一組。' },
    'bd.unlist.reason-event': { en: 'Unlisted together with the event “{n}” — it was cancelled.', zh: '隨活動「{n}」一同下架——該活動已取消。' },
    /* 只收窄、不回寫（2026-09-21 · D294 決定三，5.1.5.9 §2.3）：活動組合包上架卡的四句說明 */
    ...
    'bd.notfound.back':     { en: 'Back to E-Shop',                   zh: '回到電子商店' },
    ...
    /* 2026-09-21（D295）：多規格成員的規格由粉絲購買時任選，出貨依粉絲選到的規格——不再是待補 */
    'cb.note.variants':     { en: 'Includes a multi-option member — fans choose the option when they buy; the bundle ships what they chose.', zh: '含多選項成員：規格由粉絲購買時選，依粉絲選到的規格出貨。' },
    ...
    'cb.sale.percent':      { en: 'Limited-time discount %',          zh: '限時折扣 %' },
    'cb.sale.percent-hint': { en: 'Taken off the bundle price during the window.', zh: '檔期內再從組合售價折抵。' },
    ...
    'set.phone.ph':            { en: 'e.g. +886 912 345 678', zh: '例：+886 912 345 678' },
    ...
    /* 活動變體的名稱欄坐在「新增組合包」彈窗裡，主詞標題已經說了（鐵律 12）。 */
    'cpp.bd.name.ev':       { en: 'Name',                             zh: '名稱' },
    'cpp.bd.add.ev':        { en: 'Add a bundle',                     zh: '新增組合包' },
    'cpp.bd.edit.ev':       { en: 'Edit bundle',                      zh: '編輯組合包' },
    ...
    /* ── 分段版型（活動套組，2026-08-13）─────────────────────────────────
       ...
       不重述「組合包」——區塊標題已經寫了。 */
    'cpp.bd.sec.what':      { en: 'Contents', zh: '組合內容' },
    'cpp.bd.sec.what.sub':  { en: 'What this bundle contains. At least one ticket or item.',
                              zh: '這一組裡面有什麼。至少一筆票券或一件商品。' },
    ...
    'cpp.bd.sp.fan.left':      { en: '{n} sets left',                  zh: '剩 {n} 組' },
    'cpp.bd.sp.fan.soldout':   { en: 'Sold out',                       zh: '售罄' },
    'cpp.bd.sp.fan.per':       { en: '· creates {n} bundles, this is the first', zh: '· 會建立 {n} 組，這是第 1 組' },
    'cpp.bd.sp.fan.cta':       { en: 'Add to cart',                    zh: '加入購物車' },
    'cpp.bd.sp.fan.why.empty': { en: 'Nothing in this bundle yet',     zh: '這一組還沒有內容' },
    'cpp.bd.sp.fan.why.pick':  { en: 'Pick {what} first',              zh: '先選{what}' },
    'cpp.bd.sp.fan.note':      { en: 'The pickers on this card work — see how the price settles once a fan chooses. Picking here only affects this card.', zh: '這張卡的選擇器可以點，看粉絲選定後價格怎麼落到一個數字。點選只影響這張卡，不會寫回左邊。' },
    'cpp.bd.sp.foot.sub':      { en: 'List {list} · up to {n} sets',   zh: '原價 {list} · 最多 {n} 組' },
    'cpp.bd.sp.foot.sub.nosets': { en: 'List {list}',                  zh: '原價 {list}' },
    ...
    'cpp.bd.qty.up':        { en: 'Add one',                          zh: '加一張' },
    'cpp.bd.qty.down':      { en: 'Remove one',                       zh: '減一張' },
    /* 收合列與每場預覽：只勾一種「VIP × 2」；多種「VIP／搖滾區 任選 × 2」（2026-09-21 D296） */
    'cpp.bd.sum.line':      { en: '{name} × {n}',                     zh: '{name} × {n}' },
    'cpp.bd.sum.any':       { en: '{names} (pick one) × {n}',         zh: '{names} 任選 × {n}' },
    /* 原價合計旁的算式（5.1.5.4 §4 F3）：一種「VIP $4,200 × 2 ＋ T 恤 $800 ＝ $9,200」；
       多種「VIP／搖滾區（從 $3,300 起）× 2 ＋ T 恤 $800 ＝ 從 $7,400 起」 */
    'cpp.bd.calc.tix':      { en: '{name} {price} × {n}',             zh: '{name} {price} × {n}' },
    'cpp.bd.calc.tix.any':  { en: '{names} (from {price}) × {n}',     zh: '{names}（從 {price} 起）× {n}' },
    'cpp.bd.calc.item':     { en: '{name} {price}',                   zh: '{name} {price}' },
    'cpp.bd.calc.unpriced': { en: '(unpriced)',                       zh: '（未定價）' },
    ...
    /* 2026-09-21（D296）：允許票種（粉絲任選）× 每組張數 */
    'cpp.bd.sec.kind.sub':  { en: 'Which tiers fans can pick from, and how many tickets per set.',
                              zh: '粉絲可以挑哪些票種、每組幾張。' },
    ...
    'cpp.bd.sec.sess.sub':  { en: 'Every date by default — uncheck any you are not selling this on.',
                              zh: '預設每一場都適用，取消不販售的場次即可。' },
    'cpp.bd.items.sec.sub': { en: 'Items from your store, sold together with the ticket.',
                              zh: '電子商店裡的商品，跟票一起賣。' },
    /* 活動變體（2026-09-18 D293）：商品選填、純套票是正常情況；募資兩型的基礎字串不動。 */
    'cpp.bd.items.sec.sub.ev': { en: 'Optional. Items from your store, sold together with the tickets.',
                              zh: '選填。電子商店裡的商品，跟票一起賣。' },
    'cpp.bd.perks.sec.sub': { en: 'Items with no product code — a Discord role, a credit, a draw entry.',
    ...
    'cpp.bd.disc.on':       { en: 'Discount this bundle',             zh: '套組優惠' },
    'cpp.bd.disc.on.sub':   { en: 'Sell it for less than the items add up to',
                              zh: '用低於內容合計的價格賣這一組' },
    /* 販售數量：不限量／限量二選一（比照建立商品的「庫存」） */
    'cpp.bd.sec.qty':       { en: 'Quantity',                         zh: '販售數量' },
    'cpp.bd.sec.qty.sub':   { en: 'How many of this bundle can be sold.',
                              zh: '這一組最多可以賣出幾份。' },
    'cpp.bd.qty.unlim.sub': { en: 'Capped only by ticket and product stock',
                              zh: '只受票券與商品庫存限制' },
    ...
    /* 選項卡的說明（自成一張分卡之後，「會長出幾組」寫在這裡，不再塞進挑選器） */
    'cpp.bd.scope.shared.sub': { en: 'Fans pick the date when they buy.',
                              zh: '粉絲購買時再挑場次。' },
    ...
    'cpp.bd.sec.scope.sub': { en: 'This event runs on several dates — one bundle across all of them, or one per date.',
                              zh: '這個活動有多場，要一組通用，還是每一場各出一組。' },
    ...
    /* 扣庫存的說法（2026-09-18 D292）：賣掉一組，清單上每一種票各扣它的張數。
       墓碑：`cpp.bd.deduct.one`／`.many`（「粉絲擇一」語意下的兩句）。 */
    /* 2026-09-21（D296）：賣一組即從粉絲選到的那個票種扣 n 張 */
    'cpp.bd.deduct':        { en: 'Selling one deducts the per-set quantity from the tier the fan picks.',
                              zh: '售出一組時，從粉絲選到的票種扣除每組張數。' },
    ...
    /* 售出上限的硬頂（2026-09-18 D292，5.1.5.4 §4 F4）＝各成員 floor(剩餘 ÷ 每套用量) 取最小：
       票券看票種張數 ÷ 每套張數、商品看庫存。前身（2026-08-13）只看票、每套恆 1 張。 */
    'cpp.bd.cap.max':       { en: 'Up to {n} — set by ticket and product stock.',
                              zh: '依票券與商品庫存，最多可賣 {n} 組。' },
    'cpp.bd.cap.over':      { en: 'Over the limit — up to {n}, set by ticket and product stock.',
                              zh: '超過了：依票券與商品庫存，最多可賣 {n} 組。' },
    ...
    /* 墓碑（2026-09-09，D253）：orders.pay.refunded 移除——平台不提供任何退款動作，
       退款一律先發生在平台外且必先於撤銷，故以「已取消」單一狀態表達，見
    ...
    /* 已取消（2026-09-08，上游 2026-09-07 訂單撤銷政策；2026-09-09 隨 D253 取代原本
       「Refund / dispute」裡的退款部分）：訂單所有品項都被撤銷後的終態。與 orders.pay.*
    ...
    /* voided>0 時的變體（D242，2026-09-03；2026-09-09 隨 D253 收斂觸發源）：Admin 撤銷後
       被撤銷品項的領取單位轉 void，彙總要能分辨「還有幾件待領」與「幾件已因撤銷失效」
       （規格 5.1.5.3.1 §2.3.1）。 */
    ...
    /* 2026-09-08 建、2026-09-09 隨 D253 收斂：領取單位與品項層彙總的終態統一叫
       「已取消（Cancelled）」。唯一觸發源是 Admin 撤銷——D242 原本的第二觸發源
    ...
    /* ─── 撤銷品項（Void，2026-09-08）───────────────────────────
       Admin 專屬、逐筆品項、2.2 只做取貨型；規則見 documents/5.1.5.3.1-訂單詳情.md。
       停用理由兩句話各自對應一種不能按的原因，掛在按鈕的 title 上（＝可讀的原因）。
       墓碑 2026-09-08：`od.void.why.unsupported` 隨出貨型／數位品項的撤銷鈕一起退役——
       使用者裁決 A 案，「待產品確認」是內部寫規格用語不該上介面，該類品項改為完全不
       顯示按鈕（見 order-detail.html 的 voidBtnHtml），不再需要停用理由。 */
    'od.col.actions':       { en: 'Actions',                 zh: '操作' },
    'od.void.action':       { en: 'Void',                    zh: '撤銷' },
    'od.void.why.admin':    { en: 'Requires the Admin role',  zh: '需要 Admin 角色' },
    'od.void.why.redeemed': { en: "Already picked up — can't be voided", zh: '已取貨，不可撤銷' },
    /* 2026-09-09（D253 擴大可撤銷範圍到出貨型／數位）：兩種型態各自的「已完成履約」
       停用原因，與 od.void.why.redeemed（取貨型／組合）並列，見 order-detail.html
       的 VOID_WHY_FULFILLED。 */
    'od.void.why.shipped':  { en: "Already shipped — can't be voided", zh: '已出貨，不可撤銷' },
    'od.void.why.delivered':{ en: "Already delivered — can't be voided", zh: '已交付，不可撤銷' },
    'od.void.title':        { en: 'Void item',               zh: '撤銷品項' },
    /* 彈窗第一行：動到的是哪一項（數量 × 單價，與品項表同一份數字）*/
    'od.void.qty':          { en: '{n} × {price}',           zh: '{n} 件 × {price}' },
    'od.void.stripe':       { en: 'Refund the buyer in Stripe first — voiding moves no money and never calls Stripe.', zh: '請先在 Stripe 完成人工退款；撤銷不會處理任何金流，也不會呼叫 Stripe。' },
    'od.void.effects':      { en: 'What voiding does',       zh: '撤銷之後會發生' },
    ...
    'od.void.irreversible': { en: "There's no undo — a voided item can't be reinstated.", zh: '撤銷不可逆，已撤銷的品項無法還原。' },
    ...
    'od.amt.threshold':     { en: 'Platform threshold discount', zh: '平台滿額折抵' },
    ...
    'pk.f4.note':       { en: 'Stock, orders and revenue stay in E-Shop / Orders / Earnings; ticket status and voids stay in Events.', zh: '庫存、訂單與收入仍由電子商店／訂單管理／收入管理負責；票券狀態與撤銷由活動模組負責。' },
    ...
    /* 撤銷即失效示範（D242，2026-09-03；2026-09-09 隨 D253 收斂觸發源）：Yuki H.
       （#ZT-10471，一件已撤銷一件仍可領）、Jonas P.（#ZT-10473，組合成員部分已撤銷）。
       N＝總件數扣掉已因撤銷失效的（見 js/orders-store.js 同一輪的「撤銷即失效」節）。 */
    ...
    /* D242：Admin 撤銷後該領取單位轉此狀態，與 od.unit.status.void 用同一組字樣；
    ...
    'pks.current.unnamed': { en: 'Untitled product',  zh: '尚未命名的商品' },
    ...
    /* zh 統一成「已取消」，與 od.unit.status.void／pk.st.void 同一組字樣
       （D242，2026-09-03；2026-09-08 隨撤銷明細把原本的雙詞說法收成「已取消」）。
       2026-09-09 隨 D253 改名 sc.res.refund → sc.res.void：這是撤銷後的結果狀態，
    ...
    /* 墓碑（2026-09-09，D253）：od.refund.* 一整組（title／select／amount／confirm／
       ...
       提供任何退款動作，不記錄退款金額，取消訂單品項的唯一路徑是 §2.8 撤銷
    ...
    /* 2026-08-28 撤除 dash.empty.activity.*：那張卡的空狀態隨卡一起退場。 */
    ...
    /* 平台表現那一區的區塊標題（2026-08-28）。中文「平台表現」沿用站上既有的說法
       （index.html 註解與 roy.platforms 都這樣講）；英文用 Performance 單字即可——
       在創作者後台這個位置，Platform performance 的 platform 是廢字，讀者本來就在平台上。 */
    'dash.perf.title':        { en: 'Performance',           zh: '平台表現' },
    ...
    'event-detail.kpi.voided': { en: 'Voided tickets', zh: '已撤銷票券' },
    'event-detail.kpi.voided-meta': { en: 'None yet', zh: '尚無撤銷' },
    ...
    'event-detail.ov.bundles': { en: 'Ticket bundles', zh: '組合包' },
    'event-detail.ov.none': { en: 'None yet', zh: '尚未設定' },
    'event-detail.ov.tickets.manage': { en: 'Manage tickets & bundles →', zh: '管理票務與組合包 →' },
    'ed.bd.count': { en: '{n} bundles · {m} sold', zh: '{n} 組 · 已售 {m} 組' },
    ...
    'event-detail.room.badge': { en: 'Online only', zh: '純線上' },
    'event-detail.room.link': { en: 'Room link', zh: '房間連結' },
    'event-detail.room.hint': { en: 'Where the audience watches. Sharing this link is how people get in — there is no QR to scan.', zh: '觀眾看直播的地方。把連結發出去就是入場方式，沒有 QR 要掃。' },
    'event-detail.room.copy': { en: 'Copy link', zh: '複製連結' },
    'event-detail.room.entry': { en: 'Admission', zh: '入場費' },
    'event-detail.room.seats': { en: 'Room capacity', zh: '房間人數上限' },
    'event-detail.room.seats.n': { en: '{n} viewers', zh: '{n} 人' },
    'event-detail.room.chat': { en: 'Live chat', zh: '聊天室' },
    'event-detail.room.chat.on': { en: 'On', zh: '開啟' },
    'event-detail.room.chat.off': { en: 'Off', zh: '關閉' },
    'event-detail.room.tbd': { en: 'One admission for everyone, set in the create flow. Moderation tools and a viewer list are not built yet (D149).', zh: '全場一種入場券，在建立流程設定。房間控場與觀看名單尚未實作（D149）。' },
    'event-detail.wrap.title': { en: 'Wrap-up', zh: '結案' },
    'event-detail.wrap.when': { en: 'Ended {d}', zh: '{d} 結束' },
    'event-detail.wrap.cancelled': { en: 'Cancelled — the figures below are what had already been paid', zh: '已取消——以下是取消前已付款的部分' },
    'event-detail.wrap.attended': { en: 'Attended', zh: '實際到場' },
    'event-detail.wrap.rate': { en: '{n}% of tickets sold', zh: '佔售出張數 {n}%' },
    'event-detail.wrap.noattendance': { en: 'No door check-in for this event', zh: '這種活動沒有現場報到' },
    'event-detail.wrap.noshow': { en: 'No-shows', zh: '未到場' },
    'event-detail.wrap.noshow-meta': { en: 'Sold but never scanned', zh: '買了票但沒有掃過' },
    'event-detail.wrap.net': { en: 'Net to you', zh: '淨收入' },
    'event-detail.wrap.net-meta': { en: 'After the platform fee', zh: '扣掉平台費之後' },
    ...
    'event-detail.dup.ok': { en: 'Copy into a new event', zh: '複製成新活動' },
    'event-detail.export.stub': { en: 'Export is not wired up in the prototype — the file would land in your downloads.', zh: '原型不會真的產出檔案，實際版本會下載到你的電腦。' },
    'event-detail.save.title': { en: 'This change reaches buyers', zh: '這個變更會通知到購票者' },
    'event-detail.save.body': { en: 'Saving notifies all {n} ticket holders with an event-change notice.', zh: '儲存後會對 {n} 位持票人發出活動變更通知。' },
    'event-detail.save.ok': { en: 'Save & notify', zh: '儲存並通知' },
    'event-detail.save.empty': { en: 'not set', zh: '未填' },
    'event-detail.notif.log.title': { en: 'Delivery log', zh: '寄送紀錄' },
    'event-detail.notif.log.sent': { en: 'Sent', zh: '已寄出' },
    'event-detail.notif.log.scheduled': { en: 'Scheduled', zh: '已排定' },
    'event-detail.notif.log.none': { en: 'Not sent', zh: '未寄出' },
    'event-detail.notif.log.purchase.n': { en: '{n} sent · one per paid order', zh: '已寄 {n} 封，每筆付款訂單一封' },
    'event-detail.notif.log.purchase.0': { en: 'Nothing sold yet — none sent', zh: '還沒有人買票，尚未寄出' },
    'event-detail.notif.log.reminder.done': { en: 'Sent 24 h before doors', zh: '已於開演前 24 小時寄出' },
    'event-detail.notif.log.reminder.due': { en: 'Goes out 24 h before doors · {d}', zh: '開演前 24 小時寄出 · {d}' },
    ...
    /* 2026-09-21（D296）：銷售分頁量表列的副標——允許多種票種時「VIP／Floor 任選」 */
    'ed.bd.any': { en: '{names} (pick one)', zh: '{names} 任選' },
    'ed.bd.any-suffix': { en: '(pick one)', zh: '任選' },
    /* 2026-09-18（D292 第 14 條）：票務商品子集改為「含本活動票券的組合包」篩選視圖——
       區段標題改物件名「組合包」、副標講篩選條件；分頁名（入口名）留在 event-detail.tab.bundles。 */
    'ed.bd.title':        { en: 'Bundles',   zh: '組合包' },
    'ed.bd.sub':          { en: "Bundles that include this event's tickets.", zh: '含本活動票券的組合包' },
    'ed.bd.manage':       { en: 'Manage in e-shop →', zh: '在電子商店管理 →' },
    /* 墓碑 2026-09-18：ed.bd.sub 原文「Tickets bundled with products. They draw from the same ticket pool — selling one takes a ticket from the tier it contains.／票與商品綁在一起賣的組合包，跟單賣的票共用同一個數量池」（2026-08-17 起零消費）由上面的篩選條件取代。 */
    'ed.bd.sub-legacy':   { en: 'Tickets bundled with products. They draw from the same ticket pool — selling one takes a ticket from the tier it contains.', zh: '票與商品綁在一起賣的組合包，跟單賣的票共用同一個數量池——賣掉一組就從它含的那張票扣一張。' },
    'ed.bd.contains':     { en: 'Contains',         zh: '內含' },
    'ed.bd.soldn':        { en: '{n} sold',         zh: '已售 {n} 組' },
    'ed.bd.cap':          { en: 'Cap {n}',          zh: '上限 {n} 組' },
    'ed.bd.edit-tbd':     { en: 'Bundles are set up in the create flow; editing here lands with the upstream spec (BDL-001).', zh: '組合包在建立流程設定；這裡的編輯能力等上游規格定案後補（BDL-001）。' },
    ...
    'event-detail.sv.void':  { en: 'Void record',        zh: '撤銷紀錄' },
    ...
    'event-detail.preflight.voidpolicy.title':{ en: 'Cancellation & void policy', zh: '取消與撤銷政策' },
    ...
    /* 2026-09-09（D253）：「退款與招待票」分頁 2026-08-13 已把退款搬進交易明細（見上方 event-detail.tab.refunds
       ...
       D253 平台不提供退款動作，這個分頁的內容由「退款彙總」改寫為「撤銷紀錄」（§2.9.2，位置不動）。
       墓碑：event-detail.ref.title2／ref.sub2／ref.disabled／ref.summary.title／ref.summary.meta
       （彙總卡整張撤除，改用逐筆撤銷紀錄表格）保留未用；event-detail.ref.title／ref.sub／ref.queue.title
    ...
    'event-detail.void.title': { en: 'Void record', zh: '撤銷紀錄' },
    'event-detail.void.sub': { en: 'Tickets voided for this event, and how the write-off is absorbed (§5.1.6 F5).', zh: '本活動已撤銷的票券，以及沖銷從哪裡吸收（§5.1.6 F5）。' },
    'event-detail.void.empty.title': { en: 'No tickets voided yet', zh: '尚無撤銷票券' },
    'event-detail.void.empty.sub': { en: 'Void a ticket from the Sales record below, or void every remaining ticket at once.', zh: '可從下方「銷售紀錄」逐張撤銷，或一次撤銷所有尚未撤銷的票券。' },
    ...
    'event-detail.void.col.at': { en: 'Voided at', zh: '撤銷時間' },
    'event-detail.void.col.by': { en: 'Voided by', zh: '撤銷者' },
    'event-detail.void.all': { en: 'Void all remaining tickets', zh: '整場撤銷' },
    'event-detail.void.all-disabled': { en: 'No remaining tickets to void', zh: '沒有可撤銷的票券' },
    'event-detail.void.toast.all': { en: 'Voided {n} tickets — holders will be notified.', zh: '已撤銷 {n} 張票——會通知持票人。' },
    'event-detail.void.toast.one': { en: 'Voided {n} ticket(s) — the buyer will be notified.', zh: '已撤銷 {n} 張票——會通知買家。' },
    'event-detail.void.confirm.title': { en: 'Void this ticket?', zh: '要撤銷這張票嗎？' },
    'event-detail.void.confirm.ok': { en: 'Void ticket', zh: '撤銷票券' },
    'event-detail.void.confirm.all-title': { en: 'Void all remaining tickets?', zh: '要整場撤銷嗎？' },
    'event-detail.void.confirm.all-ok': { en: 'Void all', zh: '全部撤銷' },
    'event-detail.void.confirm.all-name': { en: '{n} remaining tickets across {m} orders', zh: '{m} 筆訂單、共 {n} 張尚未撤銷的票券' },
    'event-detail.void.confirm.stripe': { en: 'Refund the buyer in Stripe first, if any refund is owed — voiding moves no money and never calls Stripe.', zh: '若需退款，請先在 Stripe 後台完成——撤銷本身不涉及金流、也不會呼叫 Stripe。' },
    'event-detail.void.confirm.effects': { en: 'What voiding does', zh: '撤銷會發生什麼' },
    ...
    'event-detail.void.confirm.irreversible': { en: 'There’s no undo — a voided ticket can’t be reinstated.', zh: '沒有復原——已撤銷的票券無法恢復。' },
    ...
    'event-detail.notif.cancel.hint': { en: 'If the event is Cancelled, ticket holders are notified. The creator can then void tickets individually or all at once — this does not happen automatically. Always on.', zh: '若活動被取消，會通知持票人。創作者之後可逐票或整場撤銷票券——不會自動觸發。永遠開啟。' },
    ...
    /* 墓碑 2026-09-09（D253）：這張彙總卡（顯示已退款金額與筆數）隨退款佇列改撤銷紀錄一併撤除，
       改用逐筆的撤銷紀錄表格（event-detail.void.col.*）。i18n key event-detail.ref.summary.title／
    ...
    /* 2026-09-09（D253）：「退款」改「撤銷沖銷」——平台不提供退款動作。 */
    'earnings.empty.tx.text':         { en: 'Income, payouts and voids show up here once they happen. You can also log income earned outside Ztor.', zh: '收入、提款與撤銷沖銷發生後會出現於此；你也可以手動補登 Ztor 以外的收入。' },
  ...
  const PERSONA_DICT = {
    ...
    nick: {
      ...
      /* 2026-09-11：訂單明細改顯示商品圖（讀 products-store 的 nick 別名 zine／tee／hoodie／cap／pin），品名跟著對到實際商品、圖文才一致 */
      'od.item1.name': { zh: '24CE High Shine Football Jersey', en: '24CE High Shine Football Jersey' },
      'od.item2.name': { zh: '26MS T-Shirt (白) (M)', en: '26MS T-Shirt (White) (M)' },
      ...
      'od.item5.name':  { zh: '26MS Hoodie (L)', en: '26MS Hoodie (L)' },
      'od.item6.name':  { zh: '祝你好命 刺繡 Logo 老帽', en: 'Wish You A Good Life embroidered cap' },
      'od.item7.name':  { zh: '祝你好命 束口工裝褲', en: 'Wish You A Good Life cargo pants' },
      ...
      /* 待處理事項面板的細項名（2026-08-28）：與上面兩行 desc 逐項對應。
         漏了這四行，面板會列出預設世界觀的品名（海上霸姬／九龍夜行／旺角狙擊、龍虎門），
         而同一則的說明講的是周湯豪的作品——同一張卡自己打自己。 */
      'alert.ip-rental.d1.name': { zh: '祝你好命 品牌識別授權', en: 'Wish You A Good Life brand-mark license' },
      'alert.stock.d1.name':     { zh: 'REALIVE 巡演精裝寫真誌', en: 'REALIVE tour photobook' },
      'alert.stock.d2.name':     { zh: 'REALIVE 白趴 官方 Tee (S)', en: 'REALIVE White Party tee (S)' },
      'alert.stock.d3.name':     { zh: 'REALIVE 巡演海報', en: 'REALIVE tour poster' },
      ...
      'alert.event.desc':     { zh: '「<em>REALIVE World Tour (China) — 重慶站 · 10/25</em>」尚未確認取消與撤銷政策與現場人力配置。', en: '<em>REALIVE World Tour (China) — Chongqing · Oct 25</em> still needs cancellation &amp; void policy and on-site staffing confirmed.' },
