...
└─ <a>.project-list__row × N           88px link-row, --accent hover, focus ring
   ...
   ├─ __goal > __goal-pct + .project-bar[aria-hidden] + __goal-amt  (4px inline padding; or .__cell--empty em-dash when no campaign)
