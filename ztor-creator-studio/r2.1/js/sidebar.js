...
(function () {
  ...
  function buildTopbar() {
    return `
    <a href="index.html" class="app-topbar__brand" aria-label="Ztor Creator Studio">${LOGO_SVG}</a>

    <nav aria-label="Primary">
      <ul class="app-topbar__nav"><span class="app-topbar__nav-highlight" aria-hidden="true"></span>${topbarNavHtml()}</ul>
    </nav>
  ...
  function buildSidebar() {
    return `
    <a href="index.html" class="app-sidebar__brand" aria-label="Ztor Creator Studio">${LOGO_SVG}</a>

    <nav aria-label="Primary">
      <ul class="app-sidebar__nav">${sidebarNavHtml()}</ul>
    </nav>
  ...
  /* Initial mount + re-mount when the display mode changes. */
  mount();
