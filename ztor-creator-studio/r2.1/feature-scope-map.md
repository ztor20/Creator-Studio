...
**data-feat 標註現況（2026-07-02 階段一：整模組入口）**：S05/S06 商店設定付款·出貨（store-settings）、S11 拍賣整線（e-shop tab＋下拉＋橫條＋清單）、S24 專案引用卡（product-detail）、O04/O09 退款爭議 KPI·篩選（orders）、O17/O18/O22/O23 粉絲記錄·退款·數位交付·退款爭議卡（order-detail）、E08/E09/E20/E22/E23/E24 提款·總覽·補登·拆解·提款·稅務（earnings）。E13–E17 收入來源分頁 r2.1 無實體可標；同頁混版本的零星欄位（階段二）按需再補。
...
| `S31.1` | 　　　低庫存門檻自訂（逐商品／逐規格，覆寫預設 10%） | Custom low-stock threshold                | 🔵 Next   | ⏳ deferred | Phase 1 用固定預設＝庫存上限 10%；最終版做可調（spec §7.2／D105） |
