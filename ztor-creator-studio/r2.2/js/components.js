...
(function () {
  ...
  var TX = {
    ...
    merch:     { icon: 'package',                           titleKey: 'tx.merch.title',     title: '<em>Tour zine vol. 02</em> × 14',               img: 'images/products/tour-zine-vol-02.webp', metaKey: 'tx.merch.meta',     meta: 'E-Shop sales · Nov 22', srcKey: 'tx.merch.src', src: 'E-Shop sales', timeKey: 'tx.merch.time', time: 'Nov 22',                     amount: '+US$392.00',            status: { key: 'status.paid',      fallback: 'Paid',      variant: 'success' } },
    licensing: { icon: 'file-text',                         titleKey: 'tx.licensing.title', title: '<em>帥到分手</em> story world → Studio Yiu',    img: 'images/projects/nick-sdfs.jpg', metaKey: 'tx.licensing.meta', meta: 'Licensing · Nov 20', srcKey: 'tx.licensing.src', src: 'Story world licensing', timeKey: 'tx.licensing.time', time: 'Nov 20',                        amount: '+US$2,400.00',          status: { key: 'status.available', fallback: 'Available', variant: 'info' } },
