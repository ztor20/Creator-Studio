...
| 零釘選（未篩選） | `.product-list__divider.product-list__divider--empty`（文案切 `e-shop.pin.hint`） | 同一條線改成方框＋引導文案＋指路連結（計數收起），位置＝草稿之後、第一列商品之前 |
