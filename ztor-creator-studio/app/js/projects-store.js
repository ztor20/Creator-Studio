...
(function () {
  ...
  /* 項目機制的標籤（2026-08-28）。與 CAT_LABEL 是兩套互補的詞彙：
     CAT_LABEL 講「作品是什麼」（音樂／專輯／電影…），這一組講「項目是什麼」
     （預購／共創／上線）——後者正是進度條在量的東西，所以磚上兩個並排才讀得懂。
     刻意不帶「項目」二字：儀表板上整排都是項目，寫了是廢字，而且 150px 的磚放不下。
     F6 表格那組完整寫法（預購項目／共創項目）是表格自己的文案，不共用。 */
  const TYPE_LABEL = {
    fund:      { en: 'Co-create', zh: '共創' },
    preorder:  { en: 'Pre-order', zh: '預購' },
    'go-live': { en: 'Release',   zh: '上線' }
  };
